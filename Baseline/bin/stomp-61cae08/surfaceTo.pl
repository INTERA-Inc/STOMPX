#!/usr/bin/perl
# surfaceTo.pl 1298 2019-07-01 22:06:29Z d3e144 https://stash.pnnl.gov/scm/stomp/stomp.git V3.0
#
#  Print banner.
#
print("\nWelcome to surfaceTo ...\n\n");
print("This perl program transforms a STOMP surface file into\n");
print("formatted input file for Gnuplot, Grapher, Igor, Matlab, Plotmtv, SciDAVis, CSV, and Tecplot.\n");
...
while ( $ARGV[0] =~ /^-/i ) {
  if( $ARGV[0] =~ /help\b/i ) {
    ...
    print "    [Options]\n";
    print "    Plotting Package Option [Gnuplot|Grapher|Igor|MatLab|Plotmtv|SciDAVis|CSV|Tecplot]\n";
    ...
    print "surfaceTo.pl csv surface.dat surface\n";
    print "  -- prints all variables as comma separated values (csv) to file surface.dat\n";
...
#
  ...
  $stops = 0;
  do {
    print("Plotting Package [Tecplot|Gnuplot|Grapher|Igor|MatLab|SciDAVis|CSV|Plotmtv]?\n");
    $plot_package = <STDIN>;
    chomp( $plot_package );
    if( $plot_package =~ /^tecplot\b/i ) {
      print("Plotting Package: Tecplot\n");
