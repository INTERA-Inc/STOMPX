...
!
      ...
      NCH = INDEX(UNTM(1:),'  ') - 1
      WRITE(IPL,'(2A)') 'Time Output Units = ',UNTM(1:NCH)
      TMIN = TM/60.
      THR = TM/3600.
      TDAY = THR/24.
      TWK = TDAY/7.
...
!
     ...
     &    UNLN(1:IDB),' = ',(VAR*XREF(3))
      ENDIF
!
!---  Discount unique borehole and fracture outputs in count  ---
!
      NVPLOTX = NVPLOT
      DO NV = 1,NVPLOT
        IF( IPLOT(NV).EQ.200 .OR. IPLOT(NV).EQ.397 .OR. 
     &    IPLOT(NV).EQ.398 .OR. IPLOT(NV).EQ.399 ) NVPLOTX = NVPLOTX - 1
      ENDDO
      WRITE(IPL,'(/,A,I9)') 'Number of Plot Variables = ',NVPLOTX
     ...
     &    'Nodes = ',NFBN
        ...
        NFX = NFBN
      ELSEIF( NWN_LW.GT.0 ) THEN
        NFX = NFLD+NWN_LW
        WRITE(IPL,'(A,I9)') 'Number of Leaky Well Nodes = ',NWN_LW
        WRITE(IPL,'(A,I9)') 'Number of Active Nodes = ',(NFX-NXP)
      ELSE
        NFX = NFLD
        WRITE(IPL,'(A,I9)') 'Number of Active Nodes = ',(NFX-NXP)
      ENDIF
...
!
     ...
     &    ISLC(63).EQ.1 ) THEN
          NVTC = 8
          WRITE(IPL,'(A,I9)') 'Number of Vertices = ',NVTC
     ...
     &        ((VAR*XE(MXZ(M),N)*COS(YE(MXZ(M),N))),M=1,4)
        ...
        ELSEIF( JFLD.GT.1 .AND. KFLD.GT.1 ) THEN
          ...
          DO N = 1,NFX
            WRITE(IPL,'(4(1PE16.9,1X))')
     &        ((VAR*XE(MYZ(M),N)*COS(YE(MYZ(M),N))),M=1,4)
          ENDDO
     ...
     &        ((VAR*XE(MX(M),N)*COS(YE(MX(M),N))),M=1,2)
        ...
        ELSEIF( JFLD.GT.1 ) THEN
          ...
          DO N = 1,NFX
            WRITE(IPL,'(2(1PE16.9,1X))')
     &        ((VAR*XE(MY(M),N)*COS(YE(MY(M),N))),M=1,2)
          ENDDO
        ELSEIF( KFLD.GT.1 ) THEN
          ...
          DO N = 1,NFX
            WRITE(IPL,'(2(1PE16.9,1X))')
     &        ((VAR*XE(MZ(M),N)*COS(YE(MZ(M),N))),M=1,2)
          ENDDO
        ENDIF
      ELSE
        IF( (IFLD.GT.1 .AND. JFLD.GT.1 .AND. KFLD.GT.1) .OR.
...
!
     ...
     &        ((VAR*XE(MXY(M),N)*SIN(YE(MXY(M),N))),M=1,4)
        ...
        ELSEIF( IFLD.GT.1 .AND. KFLD.GT.1 ) THEN
          ...
          DO N = 1,NFX
            WRITE(IPL,'(4(1PE16.9,1X))')
     &        ((VAR*XE(MXZ(M),N)*SIN(YE(MXZ(M),N))),M=1,4)
          ENDDO
        ELSEIF( JFLD.GT.1 .AND. KFLD.GT.1 ) THEN
          WRITE(IPL,'(/,2A)') 'Y-Direction Nodal Vertices, ',UNLN(1:IDB)
          DO N = 1,NFX
     ...
     &        ((VAR*XE(MYZ(M),N)*SIN(YE(MYZ(M),N))),M=1,4)
        ...
        ELSEIF( IFLD.GT.1 ) THEN
          ...
          DO N = 1,NFX
            WRITE(IPL,'(2(1PE16.9,1X))')
     &        ((VAR*XE(MX(M),N)*SIN(YE(MX(M),N))),M=1,2)
          ENDDO
        ELSEIF( JFLD.GT.1 ) THEN
          WRITE(IPL,'(/,2A)') 'Y-Direction Nodal Vertices, ',UNLN(1:IDB)
          DO N = 1,NFX
     ...
     &        ((VAR*XE(MY(M),N)*SIN(YE(MY(M),N))),M=1,2)
        ...
        ELSEIF( KFLD.GT.1 ) THEN
          ...
          DO N = 1,NFX
            WRITE(IPL,'(2(1PE16.9,1X))')
     &        ((VAR*XE(MZ(M),N)*SIN(YE(MZ(M),N))),M=1,2)
          ENDDO
        ENDIF
      ELSE
        IF( IFLD.GT.1 .AND. JFLD.GT.1 .AND. KFLD.GT.1 .OR.
...
!
          ELSEIF( IPNVX.EQ.31 ) THEN
            WRITE(IPL,'(/,2A)') SOLUT(NSL)(1:IDB),
     &        ' Activity, Bq'
            VAR = (LOG(2.D+0)/HLF(NSL))
            WRITE(IPL,FORM2) (VAR*VOL(N)*C(N,NSL),N=1,NFX)
          ENDIF
        ENDIF
!
...
!
     ...
     &      UNPLOT(IPNV)
        ELSEIF( IOM.EQ.3 ) THEN
          WRITE(IPL,'(/,2A)') 'Net Normal Pressure, ',
     &      UNPLOT(IPNV)
        ELSEIF( IOM.EQ.3 ) THEN
...
!
          IF( IPNVGC.EQ.0 ) THEN
            WRITE(IPL,'(/,2A)') 'Total Stress-xx, ',UNPLOT(IPNV)
            ISLC50X = ABS(ISLC(50))
...
!
                IF( IMODX.NE.2 .AND. IMODX.NE.4 ) THEN
                  ...
                  DVAR(N) = DVAR(N) + PROP_GM(3,IZ(N))*(PX-PCMP(N))
                ENDIF
!
!---            Thermoelasticity ---
!
                IF( IMODX.NE.3 .AND. IMODX.NE.4 ) THEN
                  BLK3X = PROP_GM(1,IZ(N))/
     &              (1.0D+0-2.0D+0*PROP_GM(2,IZ(N)))
                  DVAR(N) = DVAR(N) + PROP_GM(4,IZ(N))*BLK3X*
     &              (T(2,N)-TCMP(N))
                ENDIF
                DVAR(N) = VAR*DVAR(N)
              ENDIF
...
!
          ELSE
            WRITE(IPL,'(/,2A)') 'Effective Stress-xx, ',UNPLOT(IPNV)
...
!
      ...
      IF( IPNV.EQ.81 ) THEN
        IF( IOM.EQ.34 ) THEN
          WRITE(IPL,'(/,A)') 'Beta Factor Sg/(Sg+Sn)'
          WRITE(IPL,FORM) (PI(2,N),N=1,NFX)
        ELSE
...
!
!---    STOMP-EOR, STOMP-CO2 or STOMP-COE  ---
!
...
!
          IF( IPNVGC.EQ.0 ) THEN
            WRITE(IPL,'(/,2A)') 'Total Stress-yy, ',UNPLOT(IPNV)
            ISLC50X = ABS(ISLC(50))
            IMODX = MOD(ISLC50X,10)
            DO N = 1,NFX
              IF( IXP(N).EQ.0 ) THEN
...
!
          ELSE
            WRITE(IPL,'(/,2A)') 'Effective Stress-yy, ',UNPLOT(IPNV)
      ...
      ELSEIF( IPNV.EQ.103 ) THEN
        ...
        IUNS = 2
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Aqueous Compressibility, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*TORL(1,N),N=1,NFX)
      ELSEIF( IPNV.EQ.104 ) THEN
        ...
        IUNS = 2
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Compressibility, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*TORG(1,N),N=1,NFX)
...
!
     ...
     &      // ' Partial Pressure, ',UNPLOT(IPNV)
        ...
        ELSE
          ...
          IUNS = -2
          CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
          WRITE(IPL,'(/,2A)') 'Air/CO2 Partial Presure, ',
     &      UNPLOT(IPNV)
          WRITE(IPL,FORM) (VAR*PVA(2,N),N=1,NFX)
        ENDIF
...
!
          IF( IPNVGC.EQ.0 ) THEN
            WRITE(IPL,'(/,2A)') 'Total Stress-zz, ',UNPLOT(IPNV)
            ISLC50X = ABS(ISLC(50))
            IMODX = MOD(ISLC50X,10)
            DO N = 1,NFX
              IF( IXP(N).EQ.0 ) THEN
...
!
          ELSE
            WRITE(IPL,'(/,2A)') 'Effective Stress-zz, ',UNPLOT(IPNV)
            WRITE(IPL,FORM) (VAR*SIG_GM(3,N),N=1,NFX)
          ENDIF
        ELSE
          WRITE(IPL,'(/,2A)')'Oil/CH4 Vapor Partial Pressure ',
     &      UNPLOT(IPNV)
          WRITE(IPL,FORM) (VAR*PVO(2,N),N=1,NFX)
        ENDIF
...
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 20 May 2019.
!
!----------------------Fortran 90 Modules------------------------------!
!
      USE GLB_PAR
...
!
      ISUB_LOG = ISUB_LOG+1
      SUB_LOG(ISUB_LOG) = '/WRPLOT_BH'
      WRITE(FORM2(8:9),'(I2)') MAX( 10,ISGNP+6 )
      WRITE(FORM2(11:11),'(I1)') MIN( 9,ISGNP-1 )
!
!---  Dynamic memory allocation  ---
!
      ALLOCATE( DVAR(1:LBN_BH),STAT=ISTAT )
      IF( ISTAT.NE.0 ) THEN
        INDX = 3
        CHMSG = 'Allocation Error: DVAR'
        CALL WRMSGS( INDX )
      ENDIF
      ALLOCATE( IVAR(1:LBN_BH),STAT=ISTAT )
      IF( ISTAT.NE.0 ) THEN
        INDX = 3
        CHMSG = 'Allocation Error: IVAR'
        CALL WRMSGS( INDX )
      ENDIF
!
!---  Create a new borehole plot file with number of time steps 
!     as the file nameextension  ---
!
      FN(1:8) = 'plot_bh.'
      N1X = MIN( ICOUNT( MXSTEP+NRST ),9 )
      DO 10 N2X = 1,N1X
...
!     write flux data by surface numbers  ---
!
      WRITE(IPL,'(/,A)') '--- Field Variable Data by Borehole ' // 
     &  'Node Numbers  ---'
      WRITE(IPL,'(/,A,I9)') 'Number of Time Steps = ',NSTEP
      NCH = INDEX(UNTM(1:),'  ') - 1
      WRITE(IPL,'(2A)') 'Time Output Units = ',UNTM(1:NCH)
      ...
      WRITE(IPL,'(A,6(1PE13.6,A))') 'Time = ',TM,',s ',TMIN,',min ',THR,
     &',h ',TDAY,',day ',TWK,',wk ',TYR,',yr '
      WRITE(IPL,'(/,A,I9)') 'Number of Plot Variables = ',NVPLOT
!
!---  Reference depth of grid  ---
!
      VAR = 1.D+0
      ...
      CALL RDUNIT(UNLN,VAR,INDX)
      IDB = INDEX( UNLN(1:),'  ') - 1
      WRITE(IPL,'(/,A,I9)') 'Number of Borehole Nodes = ',NBN_BH
!
!---    Write x-dimension vertices  ---
!
      WRITE(IPL,'(/,2A)') 'X-Direction Borehole Node Vertices, ',
     &  UNLN(1:IDB)
      DO NBH = 1,N_BH
        DO NBN = ID_BH(3,NBH),ID_BH(4,NBH)
          WRITE(IPL,'(8(1PE16.9,1X))') ((VAR*XE_BH(I,NBN)),I=1,8)
        ENDDO
      ENDDO
!
!---    Write y-dimension vertices  ---
!
      WRITE(IPL,'(/,2A)') 'Y-Direction Borehole Node Vertices, ',
     &  UNLN(1:IDB)
      DO NBH = 1,N_BH
        DO NBN = ID_BH(3,NBH),ID_BH(4,NBH)
          WRITE(IPL,'(8(1PE16.9,1X))') ((VAR*YE_BH(I,NBN)),I=1,8)
        ENDDO
      ENDDO
!
!---    Write z-dimension vertices  ---
!
      WRITE(IPL,'(/,2A)') 'Z-Direction Borehole Node Vertices, ',
     &  UNLN(1:IDB)
      DO NBH = 1,N_BH
        DO NBN = ID_BH(3,NBH),ID_BH(4,NBH)
          WRITE(IPL,'(8(1PE16.9,1X))') ((VAR*ZE_BH(I,NBN)),I=1,8)
        ENDDO
      ENDDO
!
!---  Write borehole volumes  ---
!
      WRITE(IPL,'(/,3A)') 'Borehole Node Volumes, ',UNLN(1:IDB),'^3'
      WRITE(IPL,'(10(1PE16.9,1X))') 
     &  ((((VAR**3)*VOL_BH(NBN)),NBN=ID_BH(3,NBH),ID_BH(4,NBH)),
     &  NBH=1,N_BH)
!
!---  Plot variables  ---
!
      DO 500 NV = 1,NVPLOT
        ...
        IPNVGC = IPLOTGC(NV)
        IF( IPNV.LE.16 ) THEN
          CALL WRPL_BH_1( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.16 .AND. IPNV.LE.32 ) THEN
          CALL WRPL_BH_2( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.32 .AND. IPNV.LE.48 ) THEN
          CALL WRPL_BH_3( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.48 .AND. IPNV.LE.64 ) THEN
          CALL WRPL_BH_4( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.64 .AND. IPNV.LE.80 ) THEN
          CALL WRPL_BH_5( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.80 .AND. IPNV.LE.96 ) THEN
          CALL WRPL_BH_6( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.96 .AND. IPNV.LE.112 ) THEN
          CALL WRPL_BH_7( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.112 .AND. IPNV.LE.128 ) THEN
          CALL WRPL_BH_8( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.128 .AND. IPNV.LE.144 ) THEN
          CALL WRPL_BH_9( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.144 .AND. IPNV.LE.160 ) THEN
          CALL WRPL_BH_10( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.160 .AND. IPNV.LE.176 ) THEN
          CALL WRPL_BH_11( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.176 .AND. IPNV.LE.192 ) THEN
          CALL WRPL_BH_12( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.192 .AND. IPNV.LE.208 ) THEN
          CALL WRPL_BH_13( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.208 .AND. IPNV.LE.224 ) THEN
          CALL WRPL_BH_14( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.224 .AND. IPNV.LE.240 ) THEN
          CALL WRPL_BH_15( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.240 .AND. IPNV.LE.256 ) THEN
          CALL WRPL_BH_16( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.256 .AND. IPNV.LE.272 ) THEN
          CALL WRPL_BH_17( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.273 .AND. IPNV.LE.299 ) THEN
          CALL WRPL_BH_18( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.340 .AND. IPNV.LE.400 ) THEN
          CALL WRPL_BH_20( FORM2,IPNV,IPNVGC )
        ENDIF
!
!---    Solute, conservation-component species, and
!       kinetic-component species plot output ---
...
!            ELSE
              WRITE(IPL,'(/,4A)') 'Volumetric ',SOLUT(NSL)(1:IDB),
     &          ' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) (VAR*C_BH(NBN,NSL),NBN=1,NBN_BH)
!            ENDIF
!
!---      Aqueous concentration  ---
!
...
!            ELSE
              WRITE(IPL,'(/,4A)') 'Aqueous ',
     &          SOLUT(NSL)(1:IDB), ' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) (VAR*C_BH(NBN,NSL)*YL_BH(NBN,NSL)/
     &          (SL_BH(2,NBN)+SMALL),NBN=1,NBN_BH )
!             ENDIF
!
!---      Gas concentration  ---
!
...
!            ELSE
              WRITE(IPL,'(/,4A)') 'Gas ',SOLUT(NSL)(1:IDB),
     &          ' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) (VAR*C_BH(NBN,NSL)*YG_BH(NBN,NSL)/
     &          (SG_BH(2,NBN)+SMALL),NBN=1,NBN_BH )
!!             ENDIF
!!
!!---      Nonaqueous-liquid concentration  ---
!!
...
!            ENDIF
          ELSEIF( IPNVX.EQ.5 ) THEN
            WRITE(IPL,'(/,3A)') 'Mole Fraction of ',SOLUT(NSL)(1:IDB),
     &        ' in the Aqueous Phase, '
            WRITE(IPL,FORM2) (YL_BH(NBN,NSL),NBN=1,NBN_BH)
          ELSEIF( IPNVX.EQ.6 ) THEN
            WRITE(IPL,'(/,3A)') 'Mole Fraction of ',SOLUT(NSL)(1:IDB),
     &        ' in the Gas Phase, '
            WRITE(IPL,FORM2) (YG_BH(NBN,NSL),NBN=1,NBN_BH)
!          ELSEIF( IPNVX.EQ.7 ) THEN
!            IF( IOM.EQ.1 ) THEN
!              WRITE(IPL,'(/,3A)') 'Solute Inventory of ',SOLUT(NSL)
!     &          (1:IDB)
...
!            ELSE
     ...
     &          ' Total Concentration, ',UNPLOT(IPNV)
              DO NBN = 1,NBN_BH
                DVAR(NBN) = YL_BH(NBN,NSL)+YG_BH(NBN,NSL)
              ENDDO
              WRITE(IPL,FORM2) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!            ENDIF
          ELSEIF( IPNVX.EQ.13 ) THEN
            INDX = 4
            IUNM = -3
...
!            ELSE
              WRITE(IPL,'(/,3A)') SOLUT(NSL)(1:IDB),
     &          ' Sorbed Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) (VAR*YG_BH(NBN,NSL),NBN=1,NBN_BH)
!            ENDIF
!          ELSEIF( IPNVX.EQ.22 ) THEN
!            INDX = 4
!            IUNS = -1
...
!     &          CNL(N,NSL)*SN(2,N)*VOL(N)),N=1,NFX)
!            ELSE
            WRITE(IPL,FORM2) ((VAR*C_BH(NBN,NSL)*VOL_BH(NBN))
     &        ,NBN=1,NBN_BH)
!
!---      Solute activity  ---
!
          ELSEIF( IPNVX.EQ.31 ) THEN
            WRITE(IPL,'(/,2A)') SOLUT(NSL)(1:IDB),' Activity, Bq'
            VAR = (LOG(2.D+0)/HLF(NSL))
            WRITE(IPL,FORM2) ((VAR*C_BH(NBN,NSL)*VOL_BH(NBN))
     &        ,NBN=1,NBN_BH)
          ENDIF
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_1( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Type Declarations-------------------------------!
!
      CHARACTER*16 FORM,FORMX
      REAL*8, DIMENSION(:), ALLOCATABLE ::  DVAR
!
!----------------------Executable Lines--------------------------------!
!
      ISUB_LOG = ISUB_LOG+1
      SUB_LOG(ISUB_LOG) = '/WRPL_BH_1'
      FORMX = FORM
      IPNVX = IPNV
      IPNVGCX = IPNVGC
!
...
!
      IF( IPNV.EQ.1 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Aqueous Pressure, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(PL_BH(2,NBN)+PATM),NBN=1,NBN_BH)
!
!---  Gas pressure  ---
!
      ELSEIF( IPNV.EQ.2 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Pressure, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(PG_BH(2,NBN)+PATM),NBN=1,NBN_BH)
!
!---  NAPL pressure or net normal pressure  ---
!
      ELSEIF( IPNV.EQ.3 ) THEN
        INDX = 4
        IUNM = -1
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        IF( IOM.EQ.3 ) THEN
          WRITE(IPL,'(/,2A)') 'Net Normal Pressure, ',UNPLOT(IPNV)
        ELSE
          WRITE(IPL,'(/,2A)') 'NAPL Pressure, ',UNPLOT(IPNV)
        ENDIF
        WRITE(IPL,FORM) (VAR*(PG_BH(2,NBN)+PATM),NBN=1,NBN_BH)
...
!
      ELSEIF( IPNV.EQ.4 ) THEN
        WRITE(IPL,'(/,2A)') 'Temperature, ',UNPLOT(IPNV)
        IF( UNPLOT(IPNV).EQ.'c' ) THEN
          WRITE(IPL,FORM) (T_BH(2,NBN),NBN=1,NBN_BH)
        ELSEIF( UNPLOT(IPNV).EQ.'k' ) THEN
          WRITE(IPL,FORM) ((T_BH(2,NBN)+273.15D+0),NBN=1,NBN_BH)
        ELSEIF( UNPLOT(IPNV).EQ.'f' ) THEN
          WRITE(IPL,FORM) ((T_BH(2,NBN)*1.8D+0+3.2D+1),NBN=1,NBN_BH)
        ELSEIF( UNPLOT(IPNV).EQ.'r' ) THEN
          WRITE(IPL,FORM) ((T_BH(2,NBN)*1.8D+0+4.92D+2),NBN=1,NBN_BH)
        ENDIF
!
!---  Phase condition  ---
!
      ELSEIF( IPNV.EQ.5 ) THEN
        WRITE(IPL,'(/,A)') 'Phase Condition, '
        DO NBN = 1,NBN_BH
          DVAR(NBN) = REAL(NPHAZ_BH(2,NBN))
        ENDDO
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
!---  Aqueous gauge pressure  ---
!
      ELSEIF( IPNV.EQ.6 ) THEN
        INDX = 4
        IUNM = -1
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)')'Aqueous Gauge Pressure, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*PL_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Gas gauge pressure  ---
!
      ELSEIF( IPNV.EQ.7 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Gauge Pressure, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*PG_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Aqueous saturation  ---
!
      ELSEIF( IPNV.EQ.11 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Saturation'
        WRITE(IPL,FORM) (SL_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Gas saturation  ---
!
      ELSEIF( IPNV.EQ.12 ) THEN
        WRITE(IPL,'(/,A)') 'Gas Saturation'
        WRITE(IPL,FORM) (SG_BH(2,NBN),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.15 ) THEN
        ...
        WRITE(IPL,FORM) (SL_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Aqueous air mole fraction  ---
!
      ELSEIF( IPNV.EQ.16 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Air Mole Fraction'
        WRITE(IPL,FORM) (XMLA_BH(2,NBN),NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_2( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!     28               Gas Hydraulic Head (Fresh Water)
!     29               NAPL Hydraulic Head (Fresh Water)
!                      or fracture mechanical aperture (m)
!     30               Rock/soil type
!     31               Aqueous relative permeability
!     32   IOM == 4    Residual NAPL saturation
!     32               Gas relative permeability
...
!
      IF( IPNV.EQ.20 ) THEN
        WRITE(IPL,'(/,A)') 'Diffusive Porosity'
        WRITE(IPL,FORM) (PORD_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Gas water mass fraction  ---
!
      ELSEIF( IPNV.EQ.21 ) THEN
        WRITE(IPL,'(/,A)') 'Gas Water Mass Fraction'
        WRITE(IPL,FORM) (XGW_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Gas air mass fraction  ---
!
      ELSEIF( IPNV.EQ.22 ) THEN
        WRITE(IPL,'(/,A)') 'Gas Air Mass Fraction'
        WRITE(IPL,FORM) (XGA_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Aqueous water mass fraction  ---
!
      ELSEIF( IPNV.EQ.24 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Water Mass Fraction'
        WRITE(IPL,FORM) (XLW_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Aqueous air mass fraction  ---
!
      ELSEIF( IPNV.EQ.25 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Air Mass Fraction'
        WRITE(IPL,FORM) (XLA_BH(2,NBN),NBN=1,NBN_BH)
!
...
!
     ...
     &    '(Fresh Water),',UNPLOT(IPNV)
        WRITE(IPL,FORM)
     &    (VAR*(PL_BH(2,NBN)/RHORL/GRAV + 
     &     5.D-1*(ZP_BH(1,NBN)+ZP_BH(2,NBN))),NBN=1,NBN_BH)
!
!---  Gas hydraulic head  ---
!
      ELSEIF( IPNV.EQ.28 ) THEN
...
!
      ELSEIF( IPNV.EQ.31 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Relative Permeability'
        WRITE(IPL,FORM) (RKL_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Gas relative permeability  ---
!
      ELSEIF( IPNV.EQ.32 ) THEN
        WRITE(IPL,'(/,A)') 'Gas Relative Permeability'
        WRITE(IPL,FORM) (RKG_BH(2,NBN),NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_3( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.34 ) THEN
        ...
        WRITE(IPL,'(/,2A)')
     &    'Aqueous Density, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*RHOL_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Gas density  ---
!
      ELSEIF( IPNV.EQ.35 ) THEN
        ...
        WRITE(IPL,'(/,2A)')
     &    'Gas Density, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*RHOG_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Total water mass  ---
!
      ELSEIF( IPNV.EQ.37 ) THEN
...
!---      Aqueous water  ---
!
          IF( IAQU.EQ.1 ) DVAR(NBN) = DVAR(NBN) + VAR*VOL_BH(NBN)*
     &      XLW_BH(2,NBN)*SL_BH(2,NBN)*RHOL_BH(2,NBN)
!
!---      Gas water  ---
!
          IF( IGAS.EQ.1 ) DVAR(NBN) = DVAR(NBN) + VAR*VOL_BH(NBN)*
...
!
      ELSEIF( IPNV.EQ.38 ) THEN
        ...
        DO NBN = 1,NBN_BH
          DVAR(NBN) = 0.D+0
          DVAR(NBN) = DVAR(NBN) + VAR*VOL_BH(NBN)*
     &      XLA_BH(2,NBN)*SL_BH(2,NBN)*RHOL_BH(2,NBN)
          IF( IEQA.GT.0 ) DVAR(NBN) = DVAR(NBN) + VAR*VOL_BH(NBN)*
     &      XGA_BH(2,NBN)*SG_BH(2,NBN)*RHOG_BH(2,NBN)
        ENDDO
        WRITE(IPL,'(/,2A)') 'Total Air Mass, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
!---  X-Dir. Thermal Conductivity  ---
!
      ELSEIF( IPNV.EQ.44 ) THEN
        INDX = 4
        IUNM = 1
        ...
        JNDX = 1
        DO NBN = 1,NBN_BH
          DVAR(NBN) = VAR*(THKL_BH(2,NBN)*SL_BH(2,NBN) + 
     &      THKG_BH(2,NBN)*SG_BH(2,NBN))
        ENDDO
        WRITE(IPL,'(/,2A)') 'X-Dir. Thermal Conductivity, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
!---  Y-Dir. Thermal Conductivity  ---
!
      ELSEIF( IPNV.EQ.45 ) THEN
        INDX = 4
        IUNM = 1
...
!
      ELSEIF( IPNV.EQ.47 ) THEN
        ...
        WRITE(IPL,'(/,2A)')'Salt Volumetric Concentration, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*TMS_BH(2,NBN),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.48 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        DO NBN = 1,NBN_BH
          DVAR(NBN) = VAR*XLS_BH(2,NBN)*RHOL_BH(2,NBN)
        ENDDO
        WRITE(IPL,'(/,2A)') 'Salt Aqueous Concentration, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_4( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.50 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        DO NBN = 1,NBN_BH
          DVAR(NBN) = VAR*TMS_BH(2,NBN)*VOL_BH(NBN)
        ENDDO
        WRITE(IPL,'(/,2A)') 'Total Salt Mass, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
!---  X-Dir. Aqueous Darcy Velocity  ---
!
      ELSEIF( IPNV.EQ.51 ) THEN
        INDX = 4
        IUNM = 1
        ...
        DO NBN1 = 1,NBN_BH
          DVAR(NBN1) = 0.D+0
          P1X(1) = 5.D-1*(XP_BH(1,NBN1)+XP_BH(2,NBN1))
          P1X(2) = 5.D-1*(YP_BH(1,NBN1)+YP_BH(2,NBN1))
          P1X(3) = 5.D-1*(ZP_BH(1,NBN1)+ZP_BH(2,NBN1))
          VARX = REAL(IPB_BH(2,NBN1)-IPB_BH(1,NBN1)+1)
          DO NCX = IPB_BH(1,NBN1),IPB_BH(2,NBN1)
            NBN2 = IBCM_BH(NCX)
            P2X(1) = 5.D-1*(XP_BH(1,NBN2)+XP_BH(2,NBN2))
            P2X(2) = 5.D-1*(YP_BH(1,NBN2)+YP_BH(2,NBN2))
            P2X(3) = 5.D-1*(ZP_BH(1,NBN2)+ZP_BH(2,NBN2))
            CALL VSUB( P2X,P1X,VNX )
            VLX = SQRT(VNX(1)**2 + VNX(2)**2 + VNX(3)**2)
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBL(1,NCX)*VDOTP(VNX,VXNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'X-Dir. Aqueous Darcy Velocity, ',UNPLOT(IPNV)
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO NCX = IPB_BH(1,NBN1),IPB_BH(2,NBN1)
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBL(1,NCX)*VDOTP(VNX,VYNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'Y-Dir. Aqueous Darcy Velocity, ',UNPLOT(IPNV)
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO NCX = IPB_BH(1,NBN1),IPB_BH(2,NBN1)
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBL(1,NCX)*VDOTP(VNX,VZNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'Z-Dir. Aqueous Darcy Velocity, ',UNPLOT(IPNV)
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO NCX = IPB_BH(1,NBN1),IPB_BH(2,NBN1)
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBG(1,NCX)*VDOTP(VNX,VXNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'X-Dir. Gas Darcy Velocity, ',UNPLOT(IPNV)
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO NCX = IPB_BH(1,NBN1),IPB_BH(2,NBN1)
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBG(1,NCX)*VDOTP(VNX,VYNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'Y-Dir. Gas Darcy Velocity, ',UNPLOT(IPNV)
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO NCX = IPB_BH(1,NBN1),IPB_BH(2,NBN1)
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBG(1,NCX)*VDOTP(VNX,VZNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'Z-Dir. Gas Darcy Velocity, ',UNPLOT(IPNV)
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO ICX = 1,2
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBQ(1,NCX)*VDOTP(VNX,VXNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'X-Dir. Heat Flux, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
!---  Y-Dir. Heat Flux  ---
!
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO ICX = 1,2
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBQ(1,NCX)*VDOTP(VNX,VYNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'Y-Dir. Heat Flux, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
!---  Z-Dir. Heat Flux  ---
!
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO ICX = 1,2
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBQ(1,NCX)*VDOTP(VNX,VZNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'Z-Dir. Heat Flux, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
!---  Webb Matching Point Head  ---
!
      ELSEIF( IPNV.EQ.63 ) THEN
        INDX = 4
        IUNM = 1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        DO NBN = 1,NBN_BH
          DVAR(NBN) = VAR*SCHR(11,IZ_BH(NBN))
        ENDDO
        WRITE(IPL,'(/,2A)') 'Webb Matching Point Head, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO NCX = IPB_BH(1,NBN1),IPB_BH(2,NBN1)
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBS(1,NCX)*VDOTP(VNX,VXNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'X-Dir. Salt Flux, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
      ENDIF
!
!---  Dynamic memory allocation  ---
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_5( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO NCX = IPB_BH(1,NBN1),IPB_BH(2,NBN1)
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBS(1,NCX)*VDOTP(VNX,VYNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'Y-Dir. Salt Flux, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
!---  Z-Dir. Salt Flux  ---
!
        ...
        DO NBN1 = 1,NBN_BH
          ...
          DO NCX = IPB_BH(1,NBN1),IPB_BH(2,NBN1)
            ...
            DO M = 1,3
              VNX(M) = VNX(M)/VLX
            ENDDO
            DVAR(NBN1) = DVAR(NBN1)+VAR*UBBS(1,NCX)*VDOTP(VNX,VZNX)/VARX
          ENDDO
        ENDDO
        WRITE(IPL,'(/,2A)')
     &    'Z-Dir. Salt Flux, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
!---  X-Dir. Salt Flux (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.67 ) THEN
        INDX = 4
        IUNKG = 1
        IUNS = -3
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL XC_FLUX_BH( UBBS,DVAR )
        WRITE(IPL,'(/,2A)')
     &    'X-Dir. Salt Flux (Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
!---  Y-Dir. Salt Flux (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.68 ) THEN
        INDX = 4
        IUNKG = 1
        IUNS = -3
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL YC_FLUX_BH( UBBS,DVAR )
        WRITE(IPL,'(/,2A)')
     &    'Y-Dir. Salt Flux (Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
!---  Z-Dir. Salt Flux (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.69 ) THEN
        INDX = 4
        IUNKG = 1
        IUNS = -3
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL ZC_FLUX_BH( UBBS,DVAR )
        WRITE(IPL,'(/,2A)')
     &    'Z-Dir. Salt Flux (Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.70 ) THEN
        WRITE(IPL,'(/,A)') 'Gas Water Mole Fraction'
        WRITE(IPL,FORM) (XMGW_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Gas Air Mole Fraction  ---
!
      ELSEIF( IPNV.EQ.71 ) THEN
        WRITE(IPL,'(/,A)') 'Gas Air Mole Fraction'
        WRITE(IPL,FORM) (XMGA_BH(2,NBN),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.73 ) THEN
        ...
        WRITE(IPL,'(/,2A)')
     &    'Gas Water Concentration, ',UNPLOT(IPNV)
        WRITE(IPL,FORM)(VAR*XGW_BH(2,NBN)*RHOG_BH(2,NBN),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.74 ) THEN
        ...
        WRITE(IPL,'(/,A)')
     &    'Gas Air Concentration, ' // UNPLOT(IPNV)
        WRITE(IPL,FORM)(VAR*XGA_BH(2,NBN)*RHOG_BH(2,NBN),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.76 ) THEN
        ...
        WRITE(IPL,'(/,2A)')
     &    'Aqueous Water Concentration, ',UNPLOT(IPNV)
        WRITE(IPL,FORM)(VAR*XLW_BH(2,NBN)*RHOL_BH(2,NBN),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.77 ) THEN
        ...
        WRITE(IPL,'(/,A)')
     &    'Aqueous Air Concentration, ' // UNPLOT(IPNV)
        WRITE(IPL,FORM)(VAR*XLA_BH(2,NBN)*RHOL_BH(2,NBN),NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_6( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      ...
      IPNVGCX = IPNVGC
!
!---  X-Dir. Aqueous Darcy Velocity (Node Centered)  ---
!
      IF( IPNV.EQ.87 ) THEN
        INDX = 4
        IUNM = 1
        IUNS = -1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL XC_FLUX_BH( UBBL,DVAR )
        WRITE(IPL,'(/,2A)') 'X-Dir. Aqueous Darcy Velocity ' //
     &    '(Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
!---  Y-Dir. Aqueous Darcy Velocity (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.88 ) THEN
        INDX = 4
        IUNM = 1
        IUNS = -1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL YC_FLUX_BH( UBBL,DVAR )
        WRITE(IPL,'(/,2A)') 'Y-Dir. Aqueous Darcy Velocity ' //
     &    '(Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
!---  Z-Dir. Aqueous Darcy Velocity (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.89 ) THEN
        INDX = 4
        IUNM = 1
        IUNS = -1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL ZC_FLUX_BH( UBBL,DVAR )
        WRITE(IPL,'(/,2A)') 'Z-Dir. Aqueous Darcy Velocity ' //
     &    '(Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
!---  X-Dir. Gas Darcy Velocity (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.90 ) THEN
        INDX = 4
        IUNM = 1
        IUNS = -1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL XC_FLUX_BH( UBBG,DVAR )
        WRITE(IPL,'(/,2A)') 'X-Dir. Gas Darcy Velocity ' //
     &    '(Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
!---  Y-Dir. Gas Darcy Velocity (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.91 ) THEN
        INDX = 4
        IUNM = 1
        IUNS = -1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL YC_FLUX_BH( UBBG,DVAR )
        WRITE(IPL,'(/,2A)') 'Y-Dir. Gas Darcy Velocity ' //
     &    '(Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
!---  Z-Dir. Gas Darcy Velocity (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.92 ) THEN
        INDX = 4
        IUNM = 1
        IUNS = -1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL ZC_FLUX_BH( UBBG,DVAR )
        WRITE(IPL,'(/,2A)') 'Z-Dir. Gas Darcy Velocity ' //
     &    '(Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
!---  X-Dir. Heat Flux (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.96 ) THEN
        INDX = 4
        IUNKG = 1
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_7( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.97 ) THEN
        ...
        IUNS = -3
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL YC_FLUX_BH( UBBQ,DVAR )
        WRITE(IPL,'(/,2A)')
     &    'Y-Dir. Heat Flux (Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
!---  Z-Dir. Heat Flux (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.98 ) THEN
        INDX = 4
        IUNKG = 1
        IUNS = -3
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        CALL ZC_FLUX_BH( UBBQ,DVAR )
        WRITE(IPL,'(/,2A)')
     &    'Z-Dir. Heat Flux (Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NBN),NBN=1,NBN_BH)
!
!---  Borehole Node Number  ---
!
      ELSEIF( IPNV.EQ.100 ) THEN
        WRITE(IPL,'(/,A)') 'Borehole Node Number'
        WRITE(IPL,FORM) (REAL(NBN),NBN=1,NBN_BH)
!
!---  Aqueous Salt Mass Fraction  ---
!
      ELSEIF( IPNV.EQ.110 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Salt Mass Fraction'
        WRITE(IPL,FORM) (XLS_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Salt Volumetric Concentration  ---
!
      ELSEIF( IPNV.EQ.111 ) THEN
...
!
      ELSEIF( IPNV.EQ.112 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Salt Aqueous Concentration, '
     &    ,UNPLOT(IPNV)
        WRITE(IPL,FORM)(VAR*XLS_BH(2,NBN)*RHOL_BH(2,NBN),NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_8( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      ...
      IF( IPNV.EQ.128 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Water Vapor Partial Pressure, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*PVW_BH(2,NBN),NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_9( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
     ...
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*PVA_BH(2,NBN),NBN=1,NBN_BH)
      ELSEIF( IPNV.EQ.137 ) THEN
        WRITE(IPL,'(/,A)')'Water Relative Humidity '
        WRITE(IPL,FORM) ((PVW_BH(2,NBN)/PSW_BH(2,NBN)),NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_10( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.150 ) THEN
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        DO NBN = 1,NBN_BH
          DVAR(NBN) = SCHR(10,IZ_BH(NBN))
        ENDDO
        WRITE(IPL,'(/,2A)') 'Webb Matching Point Saturation '
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_11( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      ...
      IPNVGCX = IPNVGC
!
!---  Aqueous Water Mole Fraction  ---
!
      IF( IPNV.EQ.168 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Water Mole Fraction'
        WRITE(IPL,FORM) (XMLW_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Aqueous viscosity  ---
!
      ELSEIF( IPNV.EQ.176 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Aqueous Viscosity, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*VISL_BH(2,NBN),NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_12( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.178 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Matric Potential Head, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(PL_BH(2,NBN)-PG_BH(2,NBN))/
     &    RHORL/GRAV,NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_13( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      ELSEIF ( IPNV.EQ.203 ) THEN
        ...
        WRITE(IPL,FORM) (RKL_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Air Aqueous Mole Fraction ---
!
      ELSEIF ( IPNV.EQ.204 ) THEN
        WRITE(IPL,'(/,A)') 'Air Aqueous Mole Fraction'
        WRITE(IPL,FORM) (XMLA_BH(2,NBN),NBN=1,NBN_BH)
!
...
!
      ELSEIF ( IPNV.EQ.205 ) THEN
        WRITE(IPL,'(/,A)') 'Salt Aqueous Mole Fraction'
        WRITE(IPL,FORM) (XMLS_BH(2,NBN),NBN=1,NBN_BH)
      ENDIF
      ISUB_LOG = ISUB_LOG-1
!
!---  End of WRPL_BH_13 group
!
      RETURN
      END
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_14( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_15( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_16( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_17( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.264 ) THEN
        WRITE(IPL,'(/,2A)') 'Precipitated Salt Saturation, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (SS_BH(2,NBN),NBN=1,NBN_BH)
      ENDIF
      ISUB_LOG = ISUB_LOG-1
!
!---  End of WRPL_BH_17 group
!
      RETURN
      END
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_18( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.289 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Viscosity, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*VISG_BH(2,NBN),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.291 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'X Node-Centroid Position, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(XP_BH(1,NBN)+XP_BH(2,NBN)),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.292 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Y Node-Centroid Position, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(YP_BH(1,NBN)+YP_BH(2,NBN)),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.293 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Z Node-Centroid Position, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(ZP_BH(1,NBN)+ZP_BH(2,NBN)),NBN=1,NBN_BH)
!
!---  Aqueous enthalpy  ---
!
      ELSEIF( IPNV.EQ.296 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Aqueous Enthalpy, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*HL_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Gas enthalpy  ---
!
      ELSEIF( IPNV.EQ.297 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Enthalpy, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*HG_BH(2,NBN),NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_BH_20( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.341 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Aqueous Internal Energy, ',UNPLOT(IPNV)
        DO NBN = 1,NBN_BH
          DVAR(NBN) = VAR*(HL_BH(2,NBN)-(PG_BH(2,NBN)+PATM)/
     &      RHOL_BH(2,NBN))
        ENDDO
        WRITE(IPL,FORM) (DVAR(NBN),NBN=1,NBN_BH)
!
...
!
      ELSEIF( IPNV.EQ.342 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Internal Energy, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*UEG_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Aqueous thermal conductivity  ---
!
      ELSEIF( IPNV.EQ.344 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Aqueous Thermal Conductivity, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*THKL_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Gas thermal conductivity  ---
!
      ELSEIF( IPNV.EQ.345 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Gas Thermal Conductivity, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*THKG_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Air aqueous diffusion coefficient  ---
!
      ELSEIF( IPNV.EQ.347 ) THEN
        INDX = 4
        IUNM = 2
        IUNS = -1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Air Aqueous Diffusion Coefficient, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DFLA_BH(2,NBN),NBN=1,NBN_BH)
!
!---  H2O gas diffusion coefficient  ---
!
      ELSEIF( IPNV.EQ.348 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'H2O Gas Diffusion Coefficient, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DFGW_BH(2,NBN),NBN=1,NBN_BH)
!
!---  Distance along borehole  ---
!
      ELSEIF( IPNV.EQ.399 ) THEN
        INDX = 4
        IUNM = 1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Distance along Borehole, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DIST_BH(NBN),NBN=1,NBN_BH)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 22 September 2017.
!
!----------------------Fortran 90 Modules------------------------------!
!
      USE GLB_PAR
...
!
      ISUB_LOG = ISUB_LOG+1
      SUB_LOG(ISUB_LOG) = '/WRPLOT_FRC'
      WRITE(FORM2(8:9),'(I2)') MAX( 10,ISGNP+6 )
      WRITE(FORM2(11:11),'(I1)') MIN( 9,ISGNP-1 )
!
!---  Dynamic memory allocation  ---
!
      ALLOCATE( DVAR(1:LT_FRC),STAT=ISTAT )
      IF( ISTAT.NE.0 ) THEN
        INDX = 3
        CHMSG = 'Allocation Error: DVAR'
        CALL WRMSGS( INDX )
      ENDIF
      ALLOCATE( IVAR(1:LT_FRC),STAT=ISTAT )
      IF( ISTAT.NE.0 ) THEN
        INDX = 3
        CHMSG = 'Allocation Error: IVAR'
        CALL WRMSGS( INDX )
      ENDIF
!
!---  Create a new fracture plot file with number of time steps 
!     as the file nameextension  ---
!
      FN(1:9) = 'plot_frc.'
      N1X = MIN( ICOUNT( MXSTEP+NRST ),9 )
...
!     write flux data by surface numbers  ---
!
      WRITE(IPL,'(/,A)') '--- Field Variable Data by Fracture ' // 
     &  'Triangle Numbers  ---'
      WRITE(IPL,'(/,A,I9)') 'Number of Time Steps = ',NSTEP
      NCH = INDEX(UNTM(1:),'  ') - 1
      WRITE(IPL,'(2A)') 'Time Output Units = ',UNTM(1:NCH)
...
!
      ...
      CALL RDUNIT(UNLN,VAR,INDX)
      IDB = INDEX( UNLN(1:),'  ') - 1
      WRITE(IPL,'(/,A,I9)') 'Number of Fracture Triangles = ',
     &  NT_FRC
      WRITE(IPL,'(/,A,I9)') 'Number of Active Fracture Triangles = ',
     &  NT_FRC-NXP_FRC
!
!---    Write x-dimension vertices  ---
!
      WRITE(IPL,'(/,2A)') 'X-Direction Fracture Triangle Vertices, ',
     &  UNLN(1:IDB)
      DO NFX = 1,NF_FRC
        DO NTX = IP_FRC(1,NFX),IP_FRC(2,NFX)
          WRITE(IPL,'(3(1PE16.9,1X))') ((VAR*XE_FRC(I,NTX)),I=1,3)
        ENDDO
      ENDDO
!
!---    Write y-dimension vertices  ---
!
      WRITE(IPL,'(/,2A)') 'Y-Direction Fracture Triangle Vertices, ',
     &  UNLN(1:IDB)
      DO NFX = 1,NF_FRC
        DO NTX = IP_FRC(1,NFX),IP_FRC(2,NFX)
          WRITE(IPL,'(3(1PE16.9,1X))') ((VAR*YE_FRC(I,NTX)),I=1,3)
        ENDDO
      ENDDO
!
!---    Write z-dimension vertices  ---
!
      WRITE(IPL,'(/,2A)') 'Z-Direction Fracture Triangle Vertices, ',
     &  UNLN(1:IDB)
      DO NFX = 1,NF_FRC
        DO NTX = IP_FRC(1,NFX),IP_FRC(2,NFX)
          WRITE(IPL,'(3(1PE16.9,1X))') ((VAR*ZE_FRC(I,NTX)),I=1,3)
        ENDDO
      ENDDO
!
!---  Fracture triangle map  ---
!
      WRITE(FORM3(6:6),'(I1)') ICOUNT(NT_FRC)+1
      WRITE(IPL,'(/,A)') 'Fracture Triangle Map'
      DO NFX = 1,NF_FRC
        DO NTX = IP_FRC(1,NFX),IP_FRC(2,NFX)
          IF( IXP_FRC(NTX).LE.0 ) THEN
            IVAR(NTX) = 0
          ELSE
            IVAR(NTX) = IXP_FRC(NTX)
          ENDIF
        ENDDO
      ENDDO
      WRITE(IPL,FORM3) (IVAR(NTX),NTX=1,IP_FRC(2,NF_FRC))
!
!---  Write triangle areas  ---
!
      WRITE(IPL,'(/,3A)') 'Fracture Triangle Area, ',UNLN(1:IDB),'^2'
      WRITE(IPL,'(10(1PE16.9,1X))') 
     &  ((((VAR**2)*AF_FRC(NTX)),NTX=IP_FRC(1,NFX),IP_FRC(2,NFX)),
     &  NFX=1,NF_FRC)
!
!---  Write triangle apertures  ---
!
      WRITE(IPL,'(/,2A)') 'Fracture Triangle Aperture, ',UNLN(1:IDB)
      WRITE(IPL,'(10(1PE16.9,1X))') 
...
!
      DO 500 NV = 1,NVPLOT
        ...
        IPNVGC = IPLOTGC(NV)
        IF( IPNV.LE.16 ) THEN
          CALL WRPL_FRC_1( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.16 .AND. IPNV.LE.32 ) THEN
          CALL WRPL_FRC_2( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.32 .AND. IPNV.LE.48 ) THEN
          CALL WRPL_FRC_3( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.48 .AND. IPNV.LE.64 ) THEN
          CALL WRPL_FRC_4( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.64 .AND. IPNV.LE.80 ) THEN
          CALL WRPL_FRC_5( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.80 .AND. IPNV.LE.96 ) THEN
          CALL WRPL_FRC_6( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.96 .AND. IPNV.LE.112 ) THEN
          CALL WRPL_FRC_7( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.112 .AND. IPNV.LE.128 ) THEN
          CALL WRPL_FRC_8( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.128 .AND. IPNV.LE.144 ) THEN
          CALL WRPL_FRC_9( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.144 .AND. IPNV.LE.160 ) THEN
          CALL WRPL_FRC_10( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.160 .AND. IPNV.LE.176 ) THEN
          CALL WRPL_FRC_11( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.176 .AND. IPNV.LE.192 ) THEN
          CALL WRPL_FRC_12( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.192 .AND. IPNV.LE.208 ) THEN
          CALL WRPL_FRC_13( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.208 .AND. IPNV.LE.224 ) THEN
          CALL WRPL_FRC_14( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.224 .AND. IPNV.LE.240 ) THEN
          CALL WRPL_FRC_15( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.240 .AND. IPNV.LE.256 ) THEN
          CALL WRPL_FRC_16( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.256 .AND. IPNV.LE.272 ) THEN
          CALL WRPL_FRC_17( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.273 .AND. IPNV.LE.299 ) THEN
          CALL WRPL_FRC_18( FORM2,IPNV,IPNVGC )
        ELSEIF( IPNV.GT.340 .AND. IPNV.LE.400 ) THEN
          CALL WRPL_FRC_20( FORM2,IPNV,IPNVGC )
        ENDIF
!
!---    Solute, conservation-component species, and
!       kinetic-component species plot output ---
              ...
              DO NTX = 1,NT_FRC
                ...
                DO M = 1,IEQ_C(1,NEQ)
                  ...
                  IF( NSP.LE.NSPL ) THEN
                    ...
                    ENDIF
                    DVAR(NTX) = DVAR(NTX) + EQ_C(M,NEQ)*SP_CX
                  ENDIF
                ENDDO
              ENDDO
              WRITE(IPL,'(/,4A)') 'Volumetric ',SOLUT(NSL)(1:IDB), 
     &          ' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) (VAR*DVAR(NTX),NTX=1,NT_FRC)
            ELSE
              WRITE(IPL,'(/,4A)') 'Volumetric ',SOLUT(NSL)(1:IDB),
     &          ' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) (VAR*C_FRC(NTX,NSL),NTX=1,NT_FRC)
            ENDIF
!
!---      Aqueous concentration  ---
!
          ELSEIF( IPNVX.EQ.2 ) THEN
            ...
            IF( NSL.GT.NSOLU ) THEN
              ...
              WRITE(IPL,'(/,4A)') 'Aqueous ',
     &          SOLUT(NSL)(1:IDB), ' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) ( VAR*DVAR(NTX)*YL_FRC(NTX,NSL)/
     &          (SL_FRC(2,NTX)*PORD_FRC(2,NTX)+SMALL),NTX=1,NT_FRC )
            ELSE
              WRITE(IPL,'(/,4A)') 'Aqueous ',
     &          SOLUT(NSL)(1:IDB), ' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) (VAR*C_FRC(NTX,NSL)*YL_FRC(NTX,NSL)/
     &          (SL_FRC(2,NTX)+SMALL),NTX=1,NT_FRC )
             ENDIF
!
!---      Gas concentration  ---
!
          ELSEIF( IPNVX.EQ.3 ) THEN
            ...
            IF( NSL.GT.NSOLU ) THEN
              ...
              WRITE(IPL,'(/,4A)') 'Gas ',SOLUT(NSL)(1:IDB),
     &          ' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) ( VAR*DVAR(NTX)*YG_FRC(NTX,NSL)/
     &          (SG_FRC(2,NTX)*PORD_FRC(2,NTX)+SMALL),NTX=1,NT_FRC )
            ELSE
              WRITE(IPL,'(/,4A)') 'Gas ',SOLUT(NSL)(1:IDB),
     &          ' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) (VAR*C_FRC(NTX,NSL)*YG_FRC(NTX,NSL)/
     &          (SG_FRC(2,NTX)+SMALL),NTX=1,NT_FRC )
            ENDIF
!
!---      Nonaqueous-liquid concentration  ---
!
          ELSEIF( IPNVX.EQ.4 ) THEN
            ...
            IF( NSL.GT.NSOLU ) THEN
              ...
              WRITE(IPL,'(/,4A)') 'Nonaqueous-Liquid',
     &          SOLUT(NSL)(1:IDB),' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) ( VAR*DVAR(NTX)*YN_FRC(NTX,NSL)/
     &          (SN_FRC(2,NTX)*PORD_FRC(2,NTX)+SMALL),NTX=1,NT_FRC )
            ELSE
              WRITE(IPL,'(/,4A)') 'Nonaqueous-Liquid',
     &          SOLUT(NSL)(1:IDB),' Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) (VAR*C_FRC(NTX,NSL)*YN_FRC(NTX,NSL)/
     &          (SN_FRC(2,NTX)*PORD_FRC(2,NTX)+SMALL),NTX=1,NT_FRC )
            ENDIF
          ELSEIF( IPNVX.EQ.5 ) THEN
            WRITE(IPL,'(/,3A)') 'Mole Fraction of ',SOLUT(NSL)(1:IDB),
     &        ' in the Aqueous Phase, '
            WRITE(IPL,FORM2) (YL_FRC(NTX,NSL),NTX=1,NT_FRC)
          ELSEIF( IPNVX.EQ.6 ) THEN
            WRITE(IPL,'(/,3A)') 'Mole Fraction of ',SOLUT(NSL)(1:IDB),
     &        ' in the Gas Phase, '
            WRITE(IPL,FORM2) (YG_FRC(NTX,NSL),NTX=1,NT_FRC)
          ELSEIF( IPNVX.EQ.7 ) THEN
            IF( IOM.EQ.1 ) THEN
              WRITE(IPL,'(/,3A)') 'Solute Inventory of ',SOLUT(NSL)
     &          (1:IDB)
     ...
     &          ' in the NAPL, '
            ENDIF
            WRITE(IPL,FORM2) (YN_FRC(NTX,NSL),NTX=1,NT_FRC )
          ELSEIF( IPNVX.EQ.12 ) THEN
            INDX = 4
            IUNM = -3
            CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
     ...
     &          ' Total Concentration, ',UNPLOT(IPNV)
              DO NTX = 1,NT_FRC
                DVAR(NTX) = YL_FRC(NTX,NSL)+YG_FRC(NTX,NSL)
              ENDDO
              WRITE(IPL,FORM2) (VAR*DVAR(NTX),NTX=1,NT_FRC)
            ENDIF
          ELSEIF( IPNVX.EQ.13 ) THEN
     ...
     &          (SN_FRC(2,NTX)*PORD_FRC(2,NTX)+SMALL),NTX=1,NT_FRC)
            ELSE
              WRITE(IPL,'(/,3A)') SOLUT(NSL)(1:IDB),
     &          ' Sorbed Concentration, ',UNPLOT(IPNV)
              WRITE(IPL,FORM2) (VAR*YG_FRC(NTX,NSL),NTX=1,NT_FRC)
            ENDIF
          ELSEIF( IPNVX.EQ.22 ) THEN
            INDX = 4
            IUNS = -1
            ...
            WRITE(IPL,'(/,3A)') SOLUT(NSL)(1:IDB),
     &        ' Bubble-Gas Flux, ',UNPLOT(IPNV)
            WRITE(IPL,FORM2) (VAR*YN_FRC(NTX,NSL),NTX=1,NT_FRC)
          ELSEIF( IPNVX.EQ.23 ) THEN
            WRITE(IPL,'(/,2A)') SOLUT(NSL)(1:IDB),' Solute Mass'
            VAR = 1.D+0
            IF( NSL.GT.NSOLU ) VAR = VAR*1.D-3
...
!     &          CNL(N,NSL)*SN(2,N)*VOL(N)),N=1,NFX)
!            ELSE
              WRITE(IPL,FORM2) ((VAR*C_FRC(NTX,NSL)*APM_FRC(2,NTX)*
     &          AF_FRC(NTX)),NTX=1,NT_FRC)
!            ENDIF
          ELSEIF( IPNVX.EQ.26 ) THEN
            INDX = 4
            IUNM = -3
...
!
          ELSEIF( IPNVX.EQ.31 ) THEN
            WRITE(IPL,'(/,2A)') SOLUT(NSL)(1:IDB),' Activity, Bq'
            VAR = (LOG(2.D+0)/HLF(NSL))
            WRITE(IPL,FORM2) (VAR*C_FRC(NTX,NSL)*VOL_FRC(NTX),
     &        NTX=1,NT_FRC)
          ENDIF
        ENDIF
  500 CONTINUE
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_1( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.1 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Aqueous Pressure, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(PL_FRC(2,NTX)+PATM),NTX=1,NT_FRC)
!
!---  Gas pressure  ---
!
      ELSEIF( IPNV.EQ.2 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Pressure, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(PG_FRC(2,NTX)+PATM),NTX=1,NT_FRC)
!
!---  NAPL pressure or net normal pressure  ---
!
      ELSEIF( IPNV.EQ.3 ) THEN
...
!
      ELSEIF( IPNV.EQ.4 ) THEN
        WRITE(IPL,'(/,2A)') 'Temperature, ',UNPLOT(IPNV)
        IF( UNPLOT(IPNV).EQ.'c' ) THEN
          WRITE(IPL,FORM) (T_FRC(2,NTX),NTX=1,NT_FRC)
        ELSEIF( UNPLOT(IPNV).EQ.'k' ) THEN
          WRITE(IPL,FORM) ((T_FRC(2,NTX)+273.15D+0),NTX=1,NT_FRC)
        ELSEIF( UNPLOT(IPNV).EQ.'f' ) THEN
          WRITE(IPL,FORM) ((T_FRC(2,NTX)*1.8D+0+3.2D+1),NTX=1,NT_FRC)
        ELSEIF( UNPLOT(IPNV).EQ.'r' ) THEN
          WRITE(IPL,FORM) ((T_FRC(2,NTX)*1.8D+0+4.92D+2),NTX=1,NT_FRC)
        ENDIF
!
!---  Phase condition  ---
!
      ELSEIF( IPNV.EQ.5 ) THEN
        WRITE(IPL,'(/,A)') 'Phase Condition, '
        DO NTX = 1,NT_FRC
          DVAR(NTX) = REAL(NPHAZ_FRC(2,NTX))
        ENDDO
        WRITE(IPL,FORM) (DVAR(NTX),NTX=1,NT_FRC)
!
!---  Aqueous gauge pressure  ---
!
      ELSEIF( IPNV.EQ.6 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)')'Aqueous Gauge Pressure, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*PL_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Gas gauge pressure  ---
!
      ELSEIF( IPNV.EQ.7 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Gauge Pressure, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*PG_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  NAPL gauge pressure  ---
!
      ELSEIF( IPNV.EQ.8 ) THEN
     ...
     &      UNPLOT(IPNV)
        ELSE
          WRITE(IPL,'(/,2A)') 'Liquid-CO2 Gauge Pressure, ',UNPLOT(IPNV)
        ENDIF
        WRITE(IPL,FORM) (VAR*PN_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Apparent aqueous saturation  ---
!
      ELSEIF( IPNV.EQ.9 ) THEN
        WRITE(IPL,'(/,A)') 'Apparent Aqueous Saturation'
        WRITE(IPL,FORM) (ASL_FRC(NTX),NTX=1,NT_FRC)
!
!---  Aqueous saturation  ---
!
      ELSEIF( IPNV.EQ.11 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Saturation'
        WRITE(IPL,FORM) (SL_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Gas saturation  ---
!
      ELSEIF( IPNV.EQ.12 ) THEN
        WRITE(IPL,'(/,A)') 'Gas Saturation'
        WRITE(IPL,FORM) (SG_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  NAPL saturation  ---
!
      ELSEIF( IPNV.EQ.13 ) THEN
        ...
        ELSE
          WRITE(IPL,'(/,A)') 'NAPL Saturation'
        ENDIF
        WRITE(IPL,FORM) (SN_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Total liquid saturation  ---
!
      ELSEIF( IPNV.EQ.14 ) THEN
        WRITE(IPL,'(/,A)') 'Total Liquid Saturation'
        WRITE(IPL,FORM) ((SL_FRC(2,NTX)+SN_FRC(2,NTX)),NTX=1,NT_FRC)
!
!---  Aqueous moisture content  ---
!
      ELSEIF( IPNV.EQ.15 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Moisture Content'
        WRITE(IPL,FORM) (SL_FRC(2,NTX)*PORD_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  NAPL moisture content  ---
!
      ELSEIF( IPNV.EQ.16 ) THEN
        WRITE(IPL,'(/,A)') 'NAPL Moisture Content'
        WRITE(IPL,FORM) (SN_FRC(2,NTX)*PORD_FRC(2,NTX),NTX=1,NT_FRC)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_2( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.17 ) THEN
        WRITE(IPL,'(/,A)') 'Total Liquid Moisture Content'
        WRITE(IPL,FORM) ((SL_FRC(2,NTX)+SN_FRC(2,NTX))*PORD_FRC(2,NTX),
     &    NTX=1,NT_FRC)
!
!---  Diffusive Porosity  ---
!
      ELSEIF( IPNV.EQ.20 ) THEN
        WRITE(IPL,'(/,A)') 'Diffusive Porosity'
        WRITE(IPL,FORM) (PORD_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Gas water mass fraction  ---
!
      ELSEIF( IPNV.EQ.21 ) THEN
        WRITE(IPL,'(/,A)') 'Gas Water Mass Fraction'
        WRITE(IPL,FORM) (XGW_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Gas air mass fraction
...
!
      ELSEIF( IPNV.EQ.22 ) THEN
        IF( IOM.EQ.43 ) THEN
          ...
          WRITE(IPL,'(/,A)') 'Gas ' // GCNM(IPNVGC)(1:NCHX)
     &      // ' Mass Fraction'
          WRITE(IPL,FORM) (XGC_FRC(IPNVGC,2,NTX),NTX=1,NT_FRC)
        ELSE
          WRITE(IPL,'(/,A)') 'Gas Air Mass Fraction'
          WRITE(IPL,FORM) (XGA_FRC(2,NTX),NTX=1,NT_FRC)
        ENDIF
!
...
!
      ELSEIF( IPNV.EQ.23 ) THEN
        IF( IOM.EQ.43 ) THEN
          ...
          WRITE(IPL,'(/,A)') 'Gas ' // GCNM(IPNVGC)(1:NCHX)
     &      // ' Mass Fraction'
          WRITE(IPL,FORM) (XNC_FRC(IPNVGC,2,NTX),NTX=1,NT_FRC)
        ELSE
          WRITE(IPL,'(/,A)') 'Gas Oil Mass Fraction'
          WRITE(IPL,FORM) (XGO_FRC(2,NTX),NTX=1,NT_FRC)
        ENDIF
!
!---  Aqueous water mass fraction  ---
!
      ELSEIF( IPNV.EQ.24 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Water Mass Fraction'
        WRITE(IPL,FORM) (XLW_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Aqueous air mass fraction  ---
!
      ELSEIF( IPNV.EQ.25 ) THEN
        IF( IOM.EQ.43 ) THEN
          WRITE(IPL,'(/,A)') 'Aqueous CO2 Mass Fraction'
          WRITE(IPL,FORM) (XLA_FRC(2,NTX),NTX=1,NT_FRC)
        ELSE
          WRITE(IPL,'(/,A)') 'Aqueous Air Mass Fraction'
          WRITE(IPL,FORM) (XLA_FRC(2,NTX),NTX=1,NT_FRC)
        ENDIF
...
!
      ELSEIF( IPNV.EQ.27 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Aqueous Hydraulic Head ' //
     &    '(Fresh Water),',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(PL_FRC(2,NTX)
     &    /RHORL/GRAV + ZP_FRC(NTX)),NTX=1,NT_FRC)
!
!---  Gas hydraulic head  ---
!
      ELSEIF( IPNV.EQ.28 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Gas Hydraulic Head ' //
     &    '(Fresh Water),',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(PG_FRC(2,NTX)
     &    /RHORL/GRAV + ZP_FRC(NTX)),NTX=1,NT_FRC)
!
!---  NAPL hydraulic head  ---
!
      ELSEIF( IPNV.EQ.29 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'NAPL Hydraulic Head ' //
     &    '(Fresh Water),',UNPLOT(IPNV)
        WRITE(IPL,FORM)(VAR*(PN_FRC(2,NTX)
     &    /RHORL/GRAV + ZP_FRC(NTX)),NTX=1,NT_FRC)
!
!---  Rock/soil type  ---
!
...
!
      ELSEIF( IPNV.EQ.31 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Relative Permeability'
        WRITE(IPL,FORM) (RKL_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Gas relative permeability  ---
!
      ELSEIF( IPNV.EQ.32 ) THEN
        WRITE(IPL,'(/,A)') 'Gas Relative Permeability'
        WRITE(IPL,FORM) (RKG_FRC(2,NTX),NTX=1,NT_FRC)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_3( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.33 ) THEN
        WRITE(IPL,'(/,A)') 'NAPL Relative Permeability'
        WRITE(IPL,FORM) (RKN_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Aqueous density  ---
!
      ELSEIF( IPNV.EQ.34 ) THEN
        ...
        WRITE(IPL,'(/,2A)')
     &    'Aqueous Density, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*RHOL_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Gas density  ---
!
      ELSEIF( IPNV.EQ.35 ) THEN
        ...
        WRITE(IPL,'(/,2A)')
     &    'Gas Density, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*RHOG_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  NAPL density  ---
!
      ELSEIF( IPNV.EQ.36 ) THEN
        ...
        WRITE(IPL,'(/,2A)')
     &    'NAPL Density, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*RHON_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Total water mass  ---
!
      ELSEIF( IPNV.EQ.37 ) THEN
...
!---      Aqueous water  ---
!
          IF( IAQU.EQ.1 ) DVAR(NTX) = DVAR(NTX) + VAR*AF_FRC(NTX)*
     &      APM_FRC(2,NTX)*XLW_FRC(2,NTX)*SL_FRC(2,NTX)*RHOL_FRC(2,NTX)
!
!---      Gas water  ---
!
          IF( IGAS.EQ.1 ) DVAR(NTX) = DVAR(NTX) + VAR*AF_FRC(NTX)*
     &      APM_FRC(2,NTX)*XGW_FRC(2,NTX)*SG_FRC(2,NTX)*RHOG_FRC(2,NTX)
        ENDDO
        WRITE(IPL,'(/,2A)') 'Total Water Mass, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NTX),NTX=1,NT_FRC)
!
      ...
      ELSEIF( IPNV.EQ.38 ) THEN
        ...
        DO NTX = 1,NT_FRC
          IF( IOM.EQ.43 ) THEN
            DVAR(NTX) = 0.D+0
            DVAR(NTX) = DVAR(NTX) +
     &        VAR*PORD_FRC(2,NTX)*VOL(NTX)*
     &        ( XLC_FRC(IPNVGC,2,NTX)*SL_FRC(2,NTX)*RHOL_FRC(2,NTX) +
     &        XGC_FRC(IPNVGC,2,NTX)*SG_FRC(2,NTX)*RHOG_FRC(2,NTX) +
     &        XNC_FRC(IPNVGC,2,NTX)*SN_FRC(2,NTX)*RHON_FRC(2,NTX) )
          ELSE
            DVAR(NTX) = 0.D+0
            DVAR(NTX) = DVAR(NTX) + VAR*AF_FRC(NTX)*
     &       APM_FRC(2,NTX)*XLA_FRC(2,NTX)*SL_FRC(2,NTX)*RHOL_FRC(2,NTX)
            IF( IEQA.GT.0 ) DVAR(NTX) = DVAR(NTX) + VAR*AF_FRC(NTX)*
     &       APM_FRC(2,NTX)*XGA_FRC(2,NTX)*SG_FRC(2,NTX)*RHOG_FRC(2,NTX)
          ENDIF
        ENDDO
        IF( IOM.EQ.43 ) THEN
          NCHX = INDEX( GCNM(IPNVGC)(1:),'  ' ) - 1
...
!
      ELSEIF( IPNV.EQ.44 ) THEN
        ...
        JNDX = 1
        DO NTX = 1,NT_FRC
          DVAR(NTX) = VAR*(THKL_FRC(2,NTX)*SL_FRC(2,NTX) + 
     &      THKG_FRC(2,NTX)*SG_FRC(2,NTX))
        ENDDO
        WRITE(IPL,'(/,2A)') 'X-Dir. Thermal Conductivity, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NTX),NTX=1,NT_FRC)
...
!
      ELSEIF( IPNV.EQ.47 ) THEN
        ...
        WRITE(IPL,'(/,2A)')'Salt Volumetric Concentration, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*TMS_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Salt Aqueous Concentration  ---
!
      ELSEIF( IPNV.EQ.48 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        DO NTX = 1,NT_FRC
          DVAR(NTX) = VAR*XLS_FRC(2,NTX)*RHOL_FRC(2,NTX)
        ENDDO
        WRITE(IPL,'(/,2A)') 'Salt Aqueous Concentration, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NTX),NTX=1,NT_FRC)
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_4( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      ...
      IPNVGCX = IPNVGC
!
!---  Maximum Local Aqueous Courant Number  ---
!
      IF( IPNV.EQ.49 ) THEN
        WRITE(IPL,'(/,A)') 'Maximum Local Aqueous Courant Number '
        WRITE(IPL,FORM) (CRNTL_FRC(NTX),NTX=1,NT_FRC)
!
!---  Total Salt Mass  ---
!
      ELSEIF( IPNV.EQ.50 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        DO NTX = 1,NT_FRC
          DVAR(NTX) = VAR*TMS_FRC(2,NTX)*AF_FRC(NTX)*APM_FRC(2,NTX)
        ENDDO
        WRITE(IPL,'(/,2A)') 'Total Salt Mass, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (DVAR(NTX),NTX=1,NT_FRC)
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_5( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      ELSEIF( IPNV.EQ.67 ) THEN
        ...
        WRITE(IPL,'(/,2A)')
     &    'X-Dir. Salt Flux (Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NTX),NTX=1,NT_FRC)
!
!---  Y-Dir. Salt Flux (Node Centered)  ---
!
      ELSEIF( IPNV.EQ.68 ) THEN
...
!
      ELSEIF( IPNV.EQ.70 ) THEN
        WRITE(IPL,'(/,A)') 'Gas Water Mole Fraction'
        WRITE(IPL,FORM) (XMGW_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Gas Air or CO2 Mole Fraction  ---
!
      ELSEIF( IPNV.EQ.71 ) THEN
        IF( IOM.EQ.30 .OR. IOM.EQ.40 .OR. IOM.EQ.43 .OR. 
     &    IOM.EQ.51 ) THEN
          ...
          WRITE(IPL,'(/,A)') 'Gas ' // GCNM(IPNVGC)(1:NCHX)
     &      // ' Mole Fraction'
          WRITE(IPL,FORM) (XMGC_FRC(IPNVGC,2,NTX),NTX=1,NT_FRC)
        ELSEIF( IOM.GE.32 .AND. IOM.LE.39 ) THEN
          WRITE(IPL,'(/,A)') 'Gas CO2 Mole Fraction'
          WRITE(IPL,FORM) (XMGA_FRC(2,NTX),NTX=1,NT_FRC)
        ELSE
          WRITE(IPL,'(/,A)') 'Gas Air Mole Fraction'
          WRITE(IPL,FORM) (XMGA_FRC(2,NTX),NTX=1,NT_FRC)
        ENDIF
!
!---  Nonaqueous Liquid Component Mole Fraction  ---
!
      ELSEIF( IPNV.EQ.72 ) THEN
        IF( IOM.EQ.51 ) THEN
          NCHX = INDEX(GCNM(IPNVGC)(1:),'  ')-1
          WRITE(IPL,'(/,A)') 'Liquid ' // GCNM(IPNVGC)(1:NCHX)
     &      // ' Mole Fraction'
          WRITE(IPL,FORM) (XMNC_FRC(IPNVGC,2,NTX),NTX=1,NT_FRC)
        ELSEIF( IOM.EQ.43 ) THEN
          NCHX = INDEX(GCNM(IPNVGC)(1:),'  ')-1
          WRITE(IPL,'(/,A)') 'Nonaqueous-Liquid ' // 
     &      GCNM(IPNVGC)(1:NCHX) // ' Mole Fraction'
        ...
        ELSE
          WRITE(IPL,'(/,A)') 'Gas Oil Mole Fraction'
          WRITE(IPL,FORM) (XMGO_FRC(2,NTX),NTX=1,NT_FRC)
        ENDIF
!
!---  Gas Water Concentration  ---
!
      ELSEIF( IPNV.EQ.73 ) THEN
        ...
        WRITE(IPL,'(/,2A)')
     &    'Gas Water Concentration, ',UNPLOT(IPNV)
        WRITE(IPL,FORM)(VAR*XGW_FRC(2,NTX)*RHOG_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Gas Air Concentration  ---
!
      ELSEIF( IPNV.EQ.74 ) THEN
     ...
     &    IOM.EQ.51 ) THEN
          ...
          WRITE(IPL,'(/,A)') 'Gas Mass ' // GCNM(IPNVGC)(1:NCHX)
     &      // ' Concentration, ' // UNPLOT(IPNV)
          WRITE(IPL,FORM) (VAR*XGC_FRC(IPNVGC,2,NTX)*RHOG_FRC(2,NTX),
     &      NTX=1,NT_FRC)
        ELSEIF( IOM.GE.32 .AND. IOM.LE.39 ) THEN
          WRITE(IPL,'(/,A)')
     &      'Gas CO2 Concentration, ' // UNPLOT(IPNV)
          WRITE(IPL,FORM) (VAR*XGA_FRC(2,NTX)*RHOG_FRC(2,NTX),
     &      NTX=1,NT_FRC)
        ELSE
          WRITE(IPL,'(/,A)')
     &      'Gas Air Concentration, ' // UNPLOT(IPNV)
...
!
      ELSEIF( IPNV.EQ.76 ) THEN
        ...
        WRITE(IPL,'(/,2A)')
     &    'Aqueous Water Concentration, ',UNPLOT(IPNV)
        WRITE(IPL,FORM)(VAR*XLW_FRC(2,NTX)*RHOL_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Aqueous Air Concentration  ---
!
      ELSEIF( IPNV.EQ.77 ) THEN
        ...
        IF( IOM.EQ.30 .OR. IOM.EQ.40 .OR. IOM.EQ.43 ) THEN
          ...
          WRITE(IPL,'(/,A)') 'Aqueous ' // GCNM(IPNVGC)(1:NCHX)
     &      // ' Concentration, ' // UNPLOT(IPNV)
          WRITE(IPL,FORM) (VAR*XLC_FRC(IPNVGC,2,NTX)*RHOL_FRC(2,NTX),
     &      NTX=1,NT_FRC)
        ELSEIF( IOM.GE.32 .AND. IOM.LE.39 ) THEN
          WRITE(IPL,'(/,A)')
     &      'Aqueous CO2 Concentration, ' // UNPLOT(IPNV)
          WRITE(IPL,FORM) (VAR*XLA_FRC(2,NTX)*RHOL_FRC(2,NTX),
     &      NTX=1,NT_FRC)
        ELSE
          WRITE(IPL,'(/,A)')
     &      'Aqueous Air Concentration, ' // UNPLOT(IPNV)
     ...
     &      NTX=1,NT_FRC)
        ENDIF
!
!---  Aqueous CH4 or Oil Concentration  ---
!
      ELSEIF( IPNV.EQ.78 ) THEN
        INDX = 4
        IUNM = -3
     ...
     &      'Aqueous Oil Concentration, ',UNPLOT(IPNV)
        ENDIF
        WRITE(IPL,FORM) (VAR*XLO_FRC(2,NTX)*RHOL_FRC(2,NTX),
     &      NTX=1,NT_FRC)
!
!---  System pressure  ---
!
      ELSEIF( IPNV.EQ.80 ) THEN
        ...
        IF( IOM.EQ.43 ) THEN
          WRITE(IPL,'(/,2A)') 'System Pressure, ',UNPLOT(IPNV)
          WRITE(IPL,FORM) (VAR*(PSO_FRC(2,NTX)+PATM),NTX=1,NT_FRC)
        ENDIF
      ENDIF
!
!---  Deallocate memory  ---
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_6( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.83 ) THEN
        IF( IOM.EQ.43 .OR. IOM.EQ.32 .OR. IOM.EQ.33 ) THEN
          WRITE(IPL,'(/,A)') 'Eclipse Gas Saturation'
          WRITE(IPL,FORM) (SI_FRC(1,NTX),NTX=1,NT_FRC)
        ENDIF
!      
!---  Eclipse oil saturation  ---
!
      ELSEIF( IPNV.EQ.84 ) THEN
        IF( IOM.EQ.43 .OR. IOM.EQ.32 .OR. IOM.EQ.33 ) THEN
          WRITE(IPL,'(/,A)') 'Eclipse Oil Saturation'
          WRITE(IPL,FORM) (SI_FRC(2,NTX),NTX=1,NT_FRC)
        ENDIF
!
!---  X-Dir. Aqueous Darcy Velocity (Node Centered)  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_7( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
     ...
     &    'Z-Dir. Heat Flux (Node Centered), ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DVAR(NTX),NTX=1,NT_FRC)
!
!---  Fracture Triangle Number  ---
!
      ELSEIF( IPNV.EQ.100 ) THEN
        WRITE(IPL,'(/,A)') 'Fracture Triangle Number'
        WRITE(IPL,FORM) (REAL(NTX),NTX=1,NT_FRC)
!
!---  Aqueous Salt Mass Fraction  ---
!
      ELSEIF( IPNV.EQ.110 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Salt Mass Fraction'
        WRITE(IPL,FORM) (XLS_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Salt Volumetric Concentration  ---
!
      ELSEIF( IPNV.EQ.111 ) THEN
...
!
      ELSEIF( IPNV.EQ.112 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Salt Aqueous Concentration, '
     &    ,UNPLOT(IPNV)
        WRITE(IPL,FORM)(VAR*XLS_FRC(2,NTX)*RHOL_FRC(2,NTX),NTX=1,NT_FRC)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_8( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      ...
      IF( IPNV.EQ.128 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Water Vapor Partial Pressure, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*PVW_FRC(2,NTX),NTX=1,NT_FRC)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_9( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      ...
      IF( IPNV.EQ.129 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Air Partial Presure, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*PVA_FRC(2,NTX),NTX=1,NT_FRC)
      ELSEIF( IPNV.EQ.137 ) THEN
        WRITE(IPL,'(/,A)')'Water Relative Humidity '
        WRITE(IPL,FORM) ((PVW_FRC(2,NTX)/PSW_FRC(2,NTX)),NTX=1,NT_FRC)
      ELSEIF( IPNV.EQ.140 ) THEN
        INDX = 4
        IUNKG = 1
        IUNS = -1
        ...
        WRITE(IPL,'(/,2A)') 'Water Mass Source Rate, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*SRCW_FRC(2,NTX),NTX=1,NT_FRC)
      ELSEIF( IPNV.EQ.141 ) THEN
        INDX = 4
        IUNKG = 1
        IUNS = -1
     ...
     &      UNPLOT(IPNV)
        ENDIF
        WRITE(IPL,FORM) (VAR*SRCA_FRC(2,NTX),NTX=1,NT_FRC)
!      ELSEIF( IPNV.EQ.142 ) THEN
!        INDX = 4
!        IUNKG = 1
!        IUNS = -1
...
!        WRITE(IPL,'(/,2A)') 'Oil Mass Source Rate, ',
!     &    UNPLOT(IPNV)
!        WRITE(IPL,FORM) (VAR*SRCO_FRC(2,NTX),NTX=1,NT_FRC)
      ELSEIF( IPNV.EQ.143 ) THEN
        INDX = 4
        IUNM = 2
        IUNKG = 1
        ...
        WRITE(IPL,'(/,2A)') 'Thermal Energy Source Rate, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*SRCT_FRC(2,NTX),NTX=1,NT_FRC)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_10( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.147 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Salt Mass Source Rate, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*SRCS_FRC(2,NTX),NTX=1,NT_FRC)
      ELSEIF( IPNV.EQ.150 ) THEN
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        DO NTX = 1,NT_FRC
          DO NFX = 1,NF_FRC
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_11( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.168 ) THEN
        WRITE(IPL,'(/,A)') 'Aqueous Water Mole Fraction'
        WRITE(IPL,FORM) (XMLW_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Aqueous viscosity  ---
!
      ELSEIF( IPNV.EQ.176 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Aqueous Viscosity, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*VISL_FRC(2,NTX),NTX=1,NT_FRC)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_12( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.178 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Matric Potential Head, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*(PL_FRC(2,NTX)-PG_FRC(2,NTX))/
     &    RHORL/GRAV,NTX=1,NT_FRC)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_13( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      ELSEIF ( IPNV.EQ.204 ) THEN
        IF( IOM.EQ.30 .OR. IOM.EQ.40 .OR. IOM.EQ.43 ) THEN
          ...
          WRITE(IPL,'(/,A)') 'Aqueous ' // GCNM(IPNVGC)(1:NCHX)
     &      // ' Mole Fraction'
          WRITE(IPL,FORM) (XMLC_FRC(IPNVGC,2,NTX),NTX=1,NT_FRC)
        ELSE
          WRITE(IPL,'(/,A)') 'CO2 Aqueous Mole Fraction'
          WRITE(IPL,FORM) (XMLA_FRC(2,NTX),NTX=1,NT_FRC)
        ENDIF
!
!---  Salt Aqueous Mole Fraction ---
!
      ELSEIF ( IPNV.EQ.205 ) THEN
        WRITE(IPL,'(/,A)') 'Salt Aqueous Mole Fraction'
        WRITE(IPL,FORM) (XMLS_FRC(2,NTX),NTX=1,NT_FRC)
      ENDIF
      ISUB_LOG = ISUB_LOG-1
!
!---  End of WRPL_FRC_13 group
!
      RETURN
      END
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_14( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_15( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_16( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.247 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'X-Direction Intrinsic Permeability, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) ((VAR*PERM_FRC(2,NTX)),NTX=1,NT_FRC)
!
!---  Y-Direction Intrinsic Permeability  ---
!
      ELSEIF( IPNV.EQ.248 ) THEN
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_17( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.264 ) THEN
        WRITE(IPL,'(/,2A)') 'Precipitated Salt Saturation, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (SS_FRC(2,NTX),NTX=1,NT_FRC)
      ENDIF
      ISUB_LOG = ISUB_LOG-1
!
!---  End of WRPL_FRC_17 group
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_18( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.289 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Viscosity, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*VISG_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  NAPL viscosity  ---
!
      ELSEIF( IPNV.EQ.290 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'NAPL Viscosity, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*VISN_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  X Node-Centroid Position  ---
!
      ELSEIF( IPNV.EQ.291 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'X Node-Centroid Position, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) ((VAR*XP_FRC(NTX)),NTX=1,NT_FRC)
!
!---  Y Node-Centroid Position  ---
!
      ELSEIF( IPNV.EQ.292 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Y Node-Centroid Position, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) ((VAR*YP_FRC(NTX)),NTX=1,NT_FRC)
!
!---  Z Node-Centroid Position  ---
!
      ELSEIF( IPNV.EQ.293 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Z Node-Centroid Position, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) ((VAR*ZP_FRC(NTX)),NTX=1,NT_FRC)
!
!---  Aqueous enthalpy  ---
!
      ELSEIF( IPNV.EQ.296 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Aqueous Enthalpy, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*HL_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Gas enthalpy  ---
!
      ELSEIF( IPNV.EQ.297 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Enthalpy, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*HG_FRC(2,NTX),NTX=1,NT_FRC)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE WRPL_FRC_20( FORM,IPNV,IPNVGC )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!
      IF( IPNV.EQ.341 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Aqueous Internal Energy, ',UNPLOT(IPNV)
        DO NTX = 1,NT_FRC
          DVAR(NTX) = VAR*(HL_FRC(2,NTX)-(PG_FRC(2,NTX)+PATM)/
     &      RHOL_FRC(2,NTX))
        ENDDO
        WRITE(IPL,FORM) (DVAR(NTX),NTX=1,NT_FRC)
!
...
!
      ELSEIF( IPNV.EQ.342 ) THEN
        ...
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Gas Internal Energy, ',UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*UEG_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Aqueous thermal conductivity  ---
!
      ELSEIF( IPNV.EQ.344 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Aqueous Thermal Conductivity, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*THKL_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Gas thermal conductivity  ---
!
      ELSEIF( IPNV.EQ.345 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Gas Thermal Conductivity, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*THKG_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Air aqueous diffusion coefficient  ---
!
      ELSEIF( IPNV.EQ.347 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'Air Aqueous Diffusion Coefficient, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DFLA_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  H2O gas diffusion coefficient  ---
!
      ELSEIF( IPNV.EQ.348 ) THEN
        ...
        WRITE(IPL,'(/,2A)') 'H2O Gas Diffusion Coefficient, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*DFGW_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Total nonaqueous liquid CO2 mole fraction of formers  ---
!
      ELSEIF( IPNV.EQ.383 ) THEN
        IF( IOM.EQ.43 ) THEN
          ...
          WRITE(IPL,'(/,A)') 'Total Petroleum Component ' // 
     &      GCNM(IPNVGC)(1:NCHX) // ' Mole Fraction'
          WRITE(IPL,FORM) (ZMC_FRC(IPNVGC,2,NTX),NTX=1,NT_FRC)
!        ELSE
!          WRITE(IPL,'(/,A)') 'Total Nonaqueous CO2 Mole ' // 
!     &      'Fraction of Formers'
!          WRITE(IPL,FORM) (ZMCA_FRC(2,NTX),NTX=1,NT_FRC)
        ENDIF
!
!---  Fracture mechanical aperture  ---
!
      ELSEIF( IPNV.EQ.397 ) THEN
        INDX = 4
        IUNM = 1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Fracture Mechanical Aperture, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*APM_FRC(2,NTX),NTX=1,NT_FRC)
!
!---  Fracture hydraulic aperture  ---
!
      ELSEIF( IPNV.EQ.398 ) THEN
        INDX = 4
        IUNM = 1
        CALL RDUNIT(UNPLOT(IPNV),VAR,INDX)
        WRITE(IPL,'(/,2A)') 'Fracture Hydraulic Aperture, ',
     &    UNPLOT(IPNV)
        WRITE(IPL,FORM) (VAR*APH_FRC(2,NTX),NTX=1,NT_FRC)
      ENDIF
!
!---  Deallocate memory  ---
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE XC_FLUX( UFX,VFX,WFX,FNCX )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Description-------------------------------------!
!
!     Node-centered x-component of flux  
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 5 March 2018.
!
!----------------------Fortran 90 Modules------------------------------!
!
      USE GLB_PAR
...
!----------------------Type Declarations-------------------------------!
!
      REAL*8, DIMENSION(LSFV,LSX) ::  UFX
      REAL*8, DIMENSION(LSFV,LSY) ::  VFX
      REAL*8, DIMENSION(LSFV,LSZ) ::  WFX
      REAL*8, DIMENSION(LFD) :: FNCX
!
!----------------------Executable Lines--------------------------------!
!
      ISUB_LOG = ISUB_LOG+1
      SUB_LOG(ISUB_LOG) = '/XC_FLUX'
!
!---  Loop over nodes  ---
!
      DO N = 1,NFLD
...
!
          IF( NS.EQ.1 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(WFX(1,NPZ)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNZ(1,NPZ)*WFX(1,NPZ)
     &          *ABS(SRFNZ(1,NPZ))/DZGP(N)
              DENOMX = DENOMX + ABS(SRFNZ(1,NPZ))/DZGP(N)
            ENDIF
!
!---      South surface  ---
!
          ELSEIF( NS.EQ.2 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(VFX(1,NPY)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNY(1,NPY)*VFX(1,NPY)
     &          *ABS(SRFNY(1,NPY))/DYGP(N)
              DENOMX = DENOMX + ABS(SRFNY(1,NPY))/DYGP(N)
            ENDIF
!
!---      West surface  ---
!
          ELSEIF( NS.EQ.3 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(UFX(1,NPX)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNX(1,NPX)*UFX(1,NPX)
     &          *ABS(SRFNX(1,NPX))/DXGP(N)
              DENOMX = DENOMX + ABS(SRFNX(1,NPX))/DXGP(N)
            ENDIF
!
!---      East surface  ---
!
          ELSEIF( NS.EQ.4 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(UFX(1,NQX)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNX(1,NQX)*UFX(1,NQX)
     &          *ABS(SRFNX(1,NQX))/DXGP(N)
              DENOMX = DENOMX + ABS(SRFNX(1,NQX))/DXGP(N)
            ENDIF
!
!---      North surface  ---
!
          ELSEIF( NS.EQ.5 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(VFX(1,NQY)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNY(1,NQY)*VFX(1,NQY)
     &          *ABS(SRFNY(1,NQY))/DYGP(N)
              DENOMX = DENOMX + ABS(SRFNY(1,NQY))/DYGP(N)
            ENDIF
!
!---      Top surface  ---
!
          ELSEIF( NS.EQ.6 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(WFX(1,NQZ)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNZ(1,NQZ)*WFX(1,NQZ)
     &          *ABS(SRFNZ(1,NQZ))/DZGP(N)
              DENOMX = DENOMX + ABS(SRFNZ(1,NQZ))/DZGP(N)
            ENDIF
          ENDIF
        ENDDO
        IF(ABS(DENOMX).GT.EPSL ) FNCX(N) = FNCX(N)/DENOMX
      ENDDO
!
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE YC_FLUX( UFX,VFX,WFX,FNCX )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Description-------------------------------------!
!
!     Node-centered y-component of flux  
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 5 March 2018.
...
!
          IF( NS.EQ.1 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(WFX(1,NPZ)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNZ(2,NPZ)*WFX(1,NPZ)
     &          *ABS(SRFNZ(2,NPZ))/DZGP(N)
              DENOMX = DENOMX + ABS(SRFNZ(2,NPZ))/DZGP(N)
            ENDIF
!
!---      South surface  ---
!
          ELSEIF( NS.EQ.2 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(VFX(1,NPY)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNY(2,NPY)*VFX(1,NPY)
     &          *ABS(SRFNY(2,NPY))/DYGP(N)
              DENOMX = DENOMX + ABS(SRFNY(2,NPY))/DYGP(N)
            ENDIF
!
!---      West surface  ---
!
          ELSEIF( NS.EQ.3 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(UFX(1,NPX)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNX(2,NPX)*UFX(1,NPX)
     &          *ABS(SRFNX(2,NPX))/DXGP(N)
              DENOMX = DENOMX + ABS(SRFNX(2,NPX))/DXGP(N)
            ENDIF
!
!---      East surface  ---
!
          ELSEIF( NS.EQ.4 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(UFX(1,NQX)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNX(2,NQX)*UFX(1,NQX)
     &          *ABS(SRFNX(2,NQX))/DXGP(N)
              DENOMX = DENOMX + ABS(SRFNX(2,NQX))/DXGP(N)
            ENDIF
!
!---      North surface  ---
!
          ELSEIF( NS.EQ.5 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(VFX(1,NQY)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNY(2,NQY)*VFX(1,NQY)
     &          *ABS(SRFNY(2,NQY))/DYGP(N)
              DENOMX = DENOMX + ABS(SRFNY(2,NQY))/DYGP(N)
            ENDIF
!
!---      Top surface  ---
!
          ELSEIF( NS.EQ.6 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(WFX(1,NQZ)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNZ(2,NQZ)*WFX(1,NQZ)
     &          *ABS(SRFNZ(2,NQZ))/DZGP(N)
              DENOMX = DENOMX + ABS(SRFNZ(2,NQZ))/DZGP(N)
            ENDIF
          ENDIF
        ENDDO
        IF(ABS(DENOMX).GT.EPSL ) FNCX(N) = FNCX(N)/DENOMX
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE ZC_FLUX( UFX,VFX,WFX,FNCX )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Description-------------------------------------!
!
!     Node-centered z-component of flux  
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 5 March 2018.
...
!
          IF( NS.EQ.1 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(WFX(1,NPZ)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNZ(3,NPZ)*WFX(1,NPZ)
     &          *ABS(SRFNZ(3,NPZ))/DZGP(N)
              DENOMX = DENOMX + ABS(SRFNZ(3,NPZ))/DZGP(N)
            ENDIF
!
!---      South surface  ---
!
          ELSEIF( NS.EQ.2 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(VFX(1,NPY)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNY(3,NPY)*VFX(1,NPY)
     &          *ABS(SRFNY(3,NPY))/DYGP(N)
              DENOMX = DENOMX + ABS(SRFNY(3,NPY))/DYGP(N)
            ENDIF
!
!---      West surface  ---
!
          ELSEIF( NS.EQ.3 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(UFX(1,NPX)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNX(3,NPX)*UFX(1,NPX)
     &          *ABS(SRFNX(3,NPX))/DXGP(N)
              DENOMX = DENOMX + ABS(SRFNX(3,NPX))/DXGP(N)
            ENDIF
!
!---      East surface  ---
!
          ELSEIF( NS.EQ.4 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(UFX(1,NQX)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNX(3,NQX)*UFX(1,NQX)
     &          *ABS(SRFNX(3,NQX))/DXGP(N)
              DENOMX = DENOMX + ABS(SRFNX(3,NQX))/DXGP(N)
            ENDIF
!
!---      North surface  ---
!
          ELSEIF( NS.EQ.5 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(VFX(1,NQY)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNY(3,NQY)*VFX(1,NQY)
     &          *ABS(SRFNY(3,NQY))/DYGP(N)
              DENOMX = DENOMX + ABS(SRFNY(3,NQY))/DYGP(N)
            ENDIF
!
!---      Top surface  ---
!
          ELSEIF( NS.EQ.6 ) THEN
            IF( ICM(5,1,N).NE.0 .OR. ABS(WFX(1,NQZ)).GT.EPSL ) THEN
              FNCX(N) = FNCX(N) + SRFNZ(3,NQZ)*WFX(1,NQZ)
     &          *ABS(SRFNZ(3,NQZ))/DZGP(N)
              DENOMX = DENOMX + ABS(SRFNZ(3,NQZ))/DZGP(N)
            ENDIF
          ENDIF
        ENDDO
        IF(ABS(DENOMX).GT.EPSL ) FNCX(N) = FNCX(N)/DENOMX
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE XC_FLUX_BH( UBBX,FNCX )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Description-------------------------------------!
!
!     Node-centered x-component of flux for borehole nodes 
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 21 May 2019.
!
!----------------------Fortran 90 Modules------------------------------!
!
      USE GLB_PAR
...
!----------------------Type Declarations-------------------------------!
!
      REAL*8, DIMENSION(LSFV,LBC_BH) ::  UBBX
      REAL*8, DIMENSION(LBN_BH) :: FNCX
!
!----------------------Executable Lines--------------------------------!
!
      ISUB_LOG = ISUB_LOG+1
      SUB_LOG(ISUB_LOG) = '/XC_FLUX_BH'
!
!---  Loop over boreholes  ---
!
      DO NBH = 1,N_BH
...
!
          DO ICX = 1,2
            ...
            IF( NCX.LE.0 ) CYCLE
            NBN2 = IBCM_BH(NCX)
            FNCX(NBN1) = FNCX(NBN1) + SRFN_BH(1,NCX)*UBBX(1,NCX)
     &        *ABS(SRFN_BH(1,NCX))/DBBM_BH(NCX)
            DENOMX = DENOMX + ABS(SRFN_BH(1,NCX))/DBBM_BH(NCX)
          ENDDO
          IF(ABS(DENOMX).GT.EPSL ) FNCX(NBN1) = FNCX(NBN1)/DENOMX
        ENDDO
      ENDDO
!
!---  Reset subroutine character string ---
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE YC_FLUX_BH( UBBX,FNCX )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Description-------------------------------------!
!
!     Node-centered y-component of flux for borehole nodes 
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 21 May 2019.
...
!
          DO ICX = 1,2
            ...
            IF( NCX.LE.0 ) CYCLE
            NBN2 = IBCM_BH(NCX)
            FNCX(NBN1) = FNCX(NBN1) + SRFN_BH(2,NCX)*UBBX(1,NCX)
     &        *ABS(SRFN_BH(2,NCX))/DBBM_BH(NCX)
            DENOMX = DENOMX + ABS(SRFN_BH(2,NCX))/DBBM_BH(NCX)
          ENDDO
          IF(ABS(DENOMX).GT.EPSL ) FNCX(NBN1) = FNCX(NBN1)/DENOMX
        ENDDO
      ENDDO
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE ZC_FLUX_BH( UBBX,FNCX )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Description-------------------------------------!
!
!     Node-centered z-component of flux for borehole nodes 
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 21 May 2019.
...
!
          DO ICX = 1,2
            ...
            IF( NCX.LE.0 ) CYCLE
            NBN2 = IBCM_BH(NCX)
            FNCX(NBN1) = FNCX(NBN1) + SRFN_BH(3,NCX)*UBBX(1,NCX)
     &        *ABS(SRFN_BH(3,NCX))/DBBM_BH(NCX)
            DENOMX = DENOMX + ABS(SRFN_BH(3,NCX))/DBBM_BH(NCX)
          ENDDO
          IF(ABS(DENOMX).GT.EPSL ) FNCX(NBN1) = FNCX(NBN1)/DENOMX
        ENDDO
      ENDDO
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE XC_FLUX_FRC( UFFX,FNCX )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Description-------------------------------------!
!
!     Node-centered x-component of flux for fracture triangles 
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 5 March 2018.
...
!----------------------Type Declarations-------------------------------!
!
      REAL*8, DIMENSION(LSFV,LFC_FRC) ::  UFFX
      REAL*8, DIMENSION(LT_FRC) :: FNCX
!
!----------------------Executable Lines--------------------------------!
!
      ISUB_LOG = ISUB_LOG+1
      SUB_LOG(ISUB_LOG) = '/XC_FLUX_FRC'
!
!---  Loop over fractures  ---
!
      DO NFX = 1,NF_FRC
...
!
          DO NCX = IPF_FRC(1,NT1X),IPF_FRC(2,NT1X)
            ...
            FNCX(NT1X) = FNCX(NT1X) + SFNC_FRC(1,NCX)*UFFX(1,NCX)
     &        *ABS(SFNC_FRC(1,NCX))/DFFM_FRC(NCX)
            DENOMX = DENOMX + ABS(SFNC_FRC(1,NCX))/DFFM_FRC(NCX)
          ENDDO
          IF(ABS(DENOMX).GT.EPSL ) FNCX(NT1X) = FNCX(NT1X)/DENOMX
        ENDDO
      ENDDO
!
!---  Reset subroutine character string ---
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE YC_FLUX_FRC( UFFX,FNCX )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Description-------------------------------------!
!
!     Node-centered y-component of flux for fracture triangles 
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 5 March 2018.
...
!
          DO NCX = IPF_FRC(1,NT1X),IPF_FRC(2,NT1X)
            NT2X = ITCM_FRC(NCX)
            IF( IXP_FRC(NT2X).EQ.0 ) CYCLE
            FNCX(NT1X) = FNCX(NT1X) + SFNC_FRC(2,NCX)*UFFX(1,NCX)
     &        *ABS(SFNC_FRC(2,NCX))/DFFM_FRC(NCX)
            DENOMX = DENOMX + ABS(SFNC_FRC(2,NCX))/DFFM_FRC(NCX)
          ENDDO
          IF(ABS(DENOMX).GT.EPSL ) FNCX(NT1X) = FNCX(NT1X)/DENOMX
        ENDDO
      ENDDO
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE ZC_FLUX_FRC( UFFX,FNCX )
!
!-------------------------Disclaimer-----------------------------------!
!
!     This material was prepared as an account of work sponsored by
...
!----------------------Description-------------------------------------!
!
!     Node-centered z-component of flux for fracture triangles 
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 5 March 2018.
...
!
          DO NCX = IPF_FRC(1,NT1X),IPF_FRC(2,NT1X)
            NT2X = ITCM_FRC(NCX)
            IF( IXP_FRC(NT2X).EQ.0 ) CYCLE
            FNCX(NT1X) = FNCX(NT1X) + SFNC_FRC(3,NCX)*UFFX(1,NCX)
     &        *ABS(SFNC_FRC(3,NCX))/DFFM_FRC(NCX)
            DENOMX = DENOMX + ABS(SFNC_FRC(3,NCX))/DFFM_FRC(NCX)
          ENDDO
          IF(ABS(DENOMX).GT.EPSL ) FNCX(NT1X) = FNCX(NT1X)/DENOMX
        ENDDO
      ENDDO
