...
!     rdlrp.F https://stash.pnnl.gov/scm/stomp/stomp.git V3.0
!
!----------------------Fortran 90 Modules------------------------------!
!
      USE GLB_PAR
...
!
        IF( ISCHRX.EQ.1 .OR. ISCHRX.EQ.11 .OR. ISCHRX.EQ.13 .OR.
     ...
     &      INDEX(ADUM(1:),'modified').NE.0 .AND.
     ...
     &      INDEX(ADUM(1:),'bc').EQ.0 ) THEN
          ...
          ELSEIF( INDEX(ADUM(1:),'mualem').NE.0 .AND.
     &      INDEX(ADUM(1:),'irreducible').NE.0 .AND.
     &      INDEX(ADUM(1:),'vg').EQ.0 .AND. 
     &      INDEX(ADUM(1:),'bc').EQ.0 ) THEN
            IRPLX = 21
     ...
     &        // ADUM(1:NCH)
          ...
          ELSEIF( INDEX(ADUM(1:),'mualem').NE.0 .AND.
     &      INDEX(ADUM(1:),'anisotropy').NE.0 .AND.
     &      INDEX(ADUM(1:),'vg').EQ.0 .AND. 
     &      INDEX(ADUM(1:),'bc').EQ.0 ) THEN
            IRPLX = IRPLX + 300
            INDX = 2
...
!
        ELSE
          IF( INDEX(ADUM(1:),'constant').NE.0 ) THEN
            ...
            INDX = 2
            CALL C_LRP( RPLCX,ISTART,ICOMMA,IROCK,IJK,CHDUM,INDX )
          ELSEIF( INDEX(ADUM(1:),'vg').NE.0 .AND.
     &      INDEX(ADUM(1:),'mualem').NE.0 ) THEN
            IRPLX = 41
            INDX = 2
            JNDX = 3
            VARB = 'Mualem Porosity Distribution Model'
            CALL MVG_LRPX( RPLCX,ISTART,ICOMMA,IROCK,IJK,CHDUM,
     &        INDX,JNDX )
          ELSEIF( INDEX(ADUM(1:),'bc').NE.0 .AND.
     &      INDEX(ADUM(1:),'mualem').NE.0 ) THEN
            IRPLX = 42
            INDX = 2
            JNDX = 3
            VARB = 'Mualem Porosity Distribution Model'
            CALL MBC_LRPX( RPLCX,ISTART,ICOMMA,IROCK,IJK,CHDUM,
     &        INDX,JNDX )
          ELSEIF( INDEX(ADUM(1:),'vg').NE.0 .AND.
     &      INDEX(ADUM(1:),'burdine').NE.0 ) THEN
            IRPLX = 43
            INDX = 2
            JNDX = 3
            VARB = 'Burdine Porosity Distribution Model'
            CALL BVG_LRPX( RPLCX,ISTART,ICOMMA,IROCK,IJK,CHDUM,
     &        INDX,JNDX )
          ELSEIF( INDEX(ADUM(1:),'bc').NE.0 .AND.
     &      INDEX(ADUM(1:),'burdine').NE.0 ) THEN
            IRPLX = 44
            ...
            JNDX = 3
            VARB = 'Burdine Porosity Distribution Model'
            CALL BBC_LRPX( RPLCX,ISTART,ICOMMA,IROCK,IJK,CHDUM,
     &        INDX,JNDX )
          ELSEIF( INDEX(ADUM(1:),'gardner').NE.0 .OR.
     &      INDEX(ADUM(1:),'rijtema').NE.0 ) THEN
            IRPLX = 9
...
!
      ELSE
        ...
        CALL RDCHR(ISTART,ICOMMA,NCH,CHDUM,ADUM)
        IF( INDEX(ADUM(1:), 'mualem').NE.0 .AND.
     &      INDEX(ADUM(1:),'vg').EQ.0 .AND. 
     &      INDEX(ADUM(1:),'bc').EQ.0 ) THEN
          IRPLX = 1
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE MVG_LRPX( RPLCX,ISTART,ICOMMA,IROCK,IJK,CHDUM,
     &  INDX,JNDX )
!
!-------------------------Disclaimer-----------------------------------!
!
...
!----------------------Description-------------------------------------!
!
!     Mualem-van Genuchten aqueous relative permeability stand alone
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 7 February 2023.
!
!----------------------Fortran 90 Modules------------------------------!
!
      USE GLB_PAR
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE MBC_LRPX( RPLCX,ISTART,ICOMMA,IROCK,IJK,CHDUM,
     &  INDX,JNDX )
!
!-------------------------Disclaimer-----------------------------------!
!
...
!----------------------Description-------------------------------------!
!
!     Mualem-Brooks/Corey aqueous relative permeability - stand alone
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 7 February 2023.
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE BVG_LRPX( RPLCX,ISTART,ICOMMA,IROCK,IJK,CHDUM,
     &  INDX,JNDX )
!
!-------------------------Disclaimer-----------------------------------!
!
...
!----------------------Description-------------------------------------!
!
!     Burdine-van Genuchten aqueous relative permeability - stand alone
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 7 February 2023.
...
!----------------------Subroutine--------------------------------------!
!
      SUBROUTINE BBC_LRPX( RPLCX,ISTART,ICOMMA,IROCK,IJK,CHDUM,
     &  INDX,JNDX )
!
!-------------------------Disclaimer-----------------------------------!
!
...
!----------------------Description-------------------------------------!
!
!     Burdine-Brooks/Corey aqueous relative permeability - stand alone
!
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 7 February 2023.
