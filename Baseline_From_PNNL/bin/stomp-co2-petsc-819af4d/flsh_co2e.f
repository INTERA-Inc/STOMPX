...
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 17 May 2002.
!
!----------------------Fortran 90 Modules------------------------------!
!
      USE GLB_PAR
...
!
   ...
   20 CONTINUE
     ...
     &  (RX(2,2)-RX(1,2)*RX(2,1)/(RX(1,1)+SMALL))
      ...
      IF( ABS(CYLSX).GT.(1.D-9*XLSMX) .OR.
     &  ABS(CXLAX).GT.(1.D-9*XLAMX) ) GOTO 10
!
...
!
   ...
   40 CONTINUE
     ...
     &  (RX(2,2)-RX(1,2)*RX(2,1)/(RX(1,1)+SMALL))
      ...
      XLAY(2) = MAX( XLAY(2)+CXLAX,0.D+0 )
      IF( ABS(CYLSX).GT.(1.D-9*XLSMX) .OR.
     &  ABS(CXLAX).GT.(1.D-9*XLAMX) ) GOTO 30
!
!---  Limit salt mass fraction  ---
!
      XLSX = MIN( YLSY(2),XLSMX )
...
!
   ...
   60 CONTINUE
      ...
      CYLSX = RPX(1)/RX(1,1)
      YLSY(2) = MAX( YLSY(2)+CYLSX,0.D+0 )
      IF( ABS(CYLSX).GT.(1.D-9*XLSMX) ) GOTO 50
!
!---  Limit salt mass fraction  ---
!
      XLSX = MIN( YLSY(2),XLSMX )
...
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 20 May 2002.
!
!----------------------Fortran 90 Modules------------------------------!
!
      USE GLB_PAR
...
!
   ...
   20 CONTINUE
      ...
      CXLAX = RPX(1)/RX(1,1)
      XLAY(2) = MAX( XLAY(2)+CXLAX,0.D+0 )
      IF( ABS(CXLAX).GT.(1.D-9*XLAMX) ) GOTO 10
      XLSX = XLSY(2)
      YLSX = YLSY(2)
      XLAX = XLAY(2)
!
...
!
   ...
   40 CONTINUE
      ...
      CXLAX = RPX(1)/RX(1,1)
      XLAY(2) = MAX( XLAY(2)+CXLAX,0.D+0 )
      IF( ABS(CXLAX).GT.(1.D-9*XLAMX) ) GOTO 30
      XLSX = XLSY(2)
      YLSX = YLSY(2)
      XLAX = XLAY(2)
!
...
!----------------------Authors-----------------------------------------!
!
!     Written by MD White, PNNL, 21 December 2011.
!
!----------------------Fortran 90 Modules------------------------------!
!
      USE GLB_PAR
