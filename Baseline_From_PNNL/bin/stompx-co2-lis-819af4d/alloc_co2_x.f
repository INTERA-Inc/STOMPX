...
!
      ...
      CHMSG = 'SS'
      CALL ALLOC_ERROR( CHMSG,ISTAT )
      ALLOCATE( SI(1:2,1:NFCGC(ID+1)),STAT=ISTAT )
      CHMSG = 'SI'
      CALL ALLOC_ERROR( CHMSG,ISTAT )
...
!     CO2 (Carbon Sequestration in Deep Saline Aquifers) Mode
!
!     Allocate global array memory for CO2 property tables
!
!----------------------Authors-----------------------------------------!
!
...
!
      ...
      CHMSG = 'ISLTBL'
      CALL ALLOC_ERROR( CHMSG,ISTAT )
      ALLOCATE( IRGTBL(1:4,1:NFCGC(ID+1)),STAT=ISTAT )
      CHMSG = 'IRGTBL'
      CALL ALLOC_ERROR( CHMSG,ISTAT )
