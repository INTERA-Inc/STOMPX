...
!
      ...
      REAL*8, DIMENSION(:), ALLOCATABLE :: TSBC,XSBC,YSBC,ZSBC
...
!
      ...
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: FXW_CW
      ...
      INTEGER :: N_CW,N_GLW,NSD_CW,NWF_CW
!
!---  End of module  ---
!
      END MODULE
...
!
      ...
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: RHOL,BTGL
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: XLA,XLW,YLS
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: XMLW
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: RKL,TRPGL
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: PVW
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: SG,SL,SS,SI
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: RHOML
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: PORD,PORT,PERMRF,POR0
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: TORL
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: VISL
...
!
      ...
      INTEGER :: ID,NP,NFCGC_G,NFC_G,NFC_L
...
!
      ...
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: ASLMIN,ASTMIN
...
!----------------------Type Declarations-------------------------------!
!
      REAL*8, DIMENSION(:), ALLOCATABLE :: CPS,RHOS,PCMP,TCMP,HCMWE
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: CMP,POR,TOR
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: PERM,SCHR
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: RPLC
      REAL*8, DIMENSION(:,:,:), ALLOCATABLE :: CPLY_SL
      REAL*8, DIMENSION(:,:,:), ALLOCATABLE :: CPLY_RL
      INTEGER, DIMENSION(:,:), ALLOCATABLE :: ISLTBL,IRLTBL
      INTEGER, DIMENSION(:), ALLOCATABLE :: ITOR,IPRF,ISCHR,ISM
      INTEGER, DIMENSION(:), ALLOCATABLE :: IRPL,IZ,ISKP
...
!
      ...
      REAL*8, DIMENSION(:,:), ALLOCATABLE :: YL,YG,YN
